 ...
 * @property birthYear Birth year of the patient eg. 1940)
 * @property gender gender of the patient eg. MALE, FEMALE, OTHER
 * @property registrationDate ACTIN registration date of the patient
 * @property hashedId Base64 encoded SHA-256 hash of source hospital's identifier,
 */
@JacksonSerializable
