...
class CurationDatabaseTest {
    ...
    fun `Should log warnings for unused curation inputs`() {
        ...
        val labTranslation = LaboratoryIdentifiers("code1", "newCode", "name1", "newName")
        val database = TestCurationFactory.createMinimalTestCurationDatabase().copy(
            ...
            laboratoryTranslations = listOf(labTranslation, LaboratoryIdentifiers("code2", "another", "name2", "someName"))
