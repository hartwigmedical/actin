...
class HospitalProvidedTumorDetailsExtractorTest {
    ...
    private val extractor = HospitalProvidedTumorDetailsExtractor(tumorCuration, lesionCuration, tumorStageDeriver)
