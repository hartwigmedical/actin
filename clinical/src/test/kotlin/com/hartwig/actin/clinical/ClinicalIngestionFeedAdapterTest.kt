...
import com.hartwig.actin.clinical.feed.emc.EMC_EXPECTED_CLINICAL_RECORD
import com.hartwig.actin.clinical.feed.emc.EMC_FEED_DIRECTORY
...
class ClinicalIngestionFeedAdapterTest {
    ...
    private lateinit var curationDatabase: CurationDatabaseContext
    ...
    fun `Should run ingestion from proper curation and feed files, read from filesystem`() {
        ...
        assertThat(clinicalRecords.first()).isEqualTo(ClinicalRecordJson.read(EMC_EXPECTED_CLINICAL_RECORD))
        ...
        assertThat(ingestionResult.unusedConfigs).containsExactlyInAnyOrder(
            ...
            UnusedCurationConfig(category = CurationCategory.MOLECULAR_TEST_IHC, input = "cps pd l1 > 20"),
