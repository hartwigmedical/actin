...
final class QuestionnaireMapping {
    ...
    static {
        ...
        KEYS_V0_1.put(QuestionnaireKey.HAS_CNS_LESIONS, null);
        KEYS_V0_1.put(QuestionnaireKey.HAS_BRAIN_LESIONS, null);
        KEYS_V0_1.put(QuestionnaireKey.HAS_BONE_LESIONS, null);
        KEYS_V0_1.put(QuestionnaireKey.HAS_LIVER_LESIONS, null);
        KEYS_V0_1.put(QuestionnaireKey.OTHER_LESIONS, null);
        KEYS_V0_1.put(QuestionnaireKey.HAS_MEASURABLE_DISEASE_RECIST, null);
