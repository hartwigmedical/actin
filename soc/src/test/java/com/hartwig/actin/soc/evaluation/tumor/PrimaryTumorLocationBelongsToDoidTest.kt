...
class PrimaryTumorLocationBelongsToDoidTest {
    ...
    fun canEvaluateUndeterminateMainCancerType() {
        ...
        val childToParentMap: Map<String, String> = mapOf(stomachAdenocarcinoma to stomachCarcinoma, stomachCarcinoma to stomachCancer,
    ...
    fun canResolveToAdenoSquamousType() {
        val mapping: AdenoSquamousMapping = ImmutableAdenoSquamousMapping.builder().adenoSquamousDoid("1").squamousDoid("2").adenoDoid("3").build()
