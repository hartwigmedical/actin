...
class ValueComparisonTest {
    ...
    fun shouldReturnTrueIfStringInCollectionMatchesValue() {
        Assert.assertTrue(ValueComparison.stringCaseInsensitivelyMatchesQueryCollection("HAYneedleSTACK", listOf("Missing", "Unknown", "Needle", "Another")))
    }

    @Test
    fun shouldReturnFalseIfNoStringInCollectionMatchesValue() {
        Assert.assertFalse(ValueComparison.stringCaseInsensitivelyMatchesQueryCollection("HAYneedleSTACK", listOf("Missing", "Unknown", "Another")))
    }
