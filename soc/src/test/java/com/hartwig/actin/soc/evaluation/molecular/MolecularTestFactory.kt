...
internal object MolecularTestFactory {
    ...
    fun withHasTumorMutationalLoadAndVariant(hasHighTumorMutationalLoad: Boolean?,
                                             variant: Variant): PatientRecord {
    ...
    fun withMicrosatelliteInstabilityAndVariant(isMicrosatelliteUnstable: Boolean?,
                                                variant: Variant): PatientRecord {
        val base = TestMolecularFactory.createMinimalTestMolecularRecord()
        return withMolecularRecord(ImmutableMolecularRecord.builder()
                .from(base)
    ...
    fun withMicrosatelliteInstabilityAndHomozygousDisruption(isMicrosatelliteUnstable: Boolean?,
                                                             homozygousDisruption: HomozygousDisruption): PatientRecord {
        val base = TestMolecularFactory.createMinimalTestMolecularRecord()
        return withMolecularRecord(ImmutableMolecularRecord.builder()
                .from(base)
                .characteristics(ImmutableMolecularCharacteristics.builder()
    ...
    fun withMicrosatelliteInstabilityAndDisruption(isMicrosatelliteUnstable: Boolean?,
                                                   disruption: Disruption): PatientRecord {
        val base = TestMolecularFactory.createMinimalTestMolecularRecord()
        return withMolecularRecord(ImmutableMolecularRecord.builder()
                .from(base)
                .characteristics(ImmutableMolecularCharacteristics.builder()
    ...
    fun withHomologousRepairDeficiencyAndVariant(isHomologousRepairDeficient: Boolean?,
                                                 variant: Variant): PatientRecord {
        val base = TestMolecularFactory.createMinimalTestMolecularRecord()
        return withMolecularRecord(ImmutableMolecularRecord.builder()
                .from(base)
    ...
    fun withHomologousRepairDeficiencyAndLoss(isHomologousRepairDeficient: Boolean?,
                                              loss: CopyNumber): PatientRecord {
        val base = TestMolecularFactory.createMinimalTestMolecularRecord()
        return withMolecularRecord(ImmutableMolecularRecord.builder()
                .from(base)
                .characteristics(ImmutableMolecularCharacteristics.builder()
    ...
    fun withHomologousRepairDeficiencyAndHomozygousDisruption(isHomologousRepairDeficient: Boolean?,
                                                              homozygousDisruption: HomozygousDisruption): PatientRecord {
        val base = TestMolecularFactory.createMinimalTestMolecularRecord()
        return withMolecularRecord(ImmutableMolecularRecord.builder()
                .from(base)
    ...
    fun withHomologousRepairDeficiencyAndDisruption(isHomologousRepairDeficient: Boolean?,
                                                    disruption: Disruption): PatientRecord {
        val base = TestMolecularFactory.createMinimalTestMolecularRecord()
        return withMolecularRecord(ImmutableMolecularRecord.builder()
                .from(base)
    ...
    fun withTumorMutationalBurdenAndHasSufficientQuality(tumorMutationalBurden: Double?,
                                                         hasSufficientQuality: Boolean): PatientRecord {
        val base = TestMolecularFactory.createMinimalTestMolecularRecord()
        return withMolecularRecord(ImmutableMolecularRecord.builder()
                .from(base)
                .characteristics(ImmutableMolecularCharacteristics.builder()
    ...
    fun withTumorMutationalLoadAndHasSufficientQuality(tumorMutationalLoad: Int?,
                                                       hasSufficientQuality: Boolean): PatientRecord {
        val base = TestMolecularFactory.createMinimalTestMolecularRecord()
        return withMolecularRecord(ImmutableMolecularRecord.builder()
                .from(base)
