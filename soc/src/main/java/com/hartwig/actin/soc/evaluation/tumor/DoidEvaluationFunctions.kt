...
internal object DoidEvaluationFunctions {
    ...
    fun isOfExclusiveDoidType(doidModel: DoidModel, tumorDoids: Set<String>?,
                              doidToMatch: String): Boolean {
        return evaluateForExclusiveMatchWithFailAndWarns(doidModel, tumorDoids, doidToMatch, emptySet(), emptySet()) == EvaluationResult.PASS
    }

    fun evaluateForExclusiveMatchWithFailAndWarns(doidModel: DoidModel, tumorDoids: Set<String>?,
                                                  doidToMatch: String, failDoids: Set<String>, warnDoids: Set<String>): EvaluationResult {
        if (tumorDoids == null) {
