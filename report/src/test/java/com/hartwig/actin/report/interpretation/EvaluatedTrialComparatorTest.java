...
public class EvaluatedTrialComparatorTest {
    ...
    public void canSortEvaluatedTrials() {
        List<EvaluatedTrial> trials = Arrays.asList(
        ...
        List<EvaluatedTrial> trialList = Lists.newArrayList(trials.get(7), trials.get(4), trials.get(2), trials.get(8),
                trials.get(1), trials.get(6), trials.get(0), trials.get(3), trials.get(5));
