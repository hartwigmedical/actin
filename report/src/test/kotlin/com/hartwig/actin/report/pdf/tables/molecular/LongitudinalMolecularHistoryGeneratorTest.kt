...
val FIRST_TEST = TestMolecularFactory.createMinimalWholeGenomeTest().copy(date = LocalDate.of(2024, 7, 21))
...
class LongitudinalMolecularHistoryGeneratorTest {
    ...
    private fun withTumorMutationalBurden(test: MolecularTest, score: Double): MolecularCharacteristics {
    ...
    private fun withMicrosatelliteStability(test: MolecularTest, isUnstable: Boolean): MolecularCharacteristics {
        return test.characteristics.copy(
