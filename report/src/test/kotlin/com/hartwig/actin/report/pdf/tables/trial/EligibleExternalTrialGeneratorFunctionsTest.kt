...
class EligibleExternalTrialGeneratorFunctionsTest {
    private val externalTrial1 = TestExternalTrialFactory.create("title1", setOf(Country(CountryName.NETHERLANDS, emptyMap()), Country(CountryName.GERMANY, emptyMap())), "url1", "nctId1")
    private val externalTrial2 = TestExternalTrialFactory.create("title2", setOf(Country(CountryName.BELGIUM, emptyMap())), "url2", "nctId2")
    private val externalTrial3 = TestExternalTrialFactory.create("title3", setOf(Country(CountryName.NETHERLANDS, emptyMap())), "url3", "nctId3")
    private val externalTrial4 = TestExternalTrialFactory.create("title4", setOf(Country(CountryName.GERMANY, emptyMap())), "url4", "nctId4")
