...
class MolecularCharacteristicsGeneratorTest {
    ...
    fun `Should not display hrd type or brca value when sample is HR proficient`() {
        val test = withHomologousRecombinationStatusAndType(false, hrScore = 0.0, HrdType.NONE, brca1Value = 0.0, brca2Value = 0.0)
    ...
    fun `Should display hrd type when type cannot be determined`() {
        val cannotBeDetermined =
            withHomologousRecombinationStatusAndType(true, hrScore = 0.8123, HrdType.CANNOT_BE_DETERMINED, brca1Value = 0.75, brca2Value = 0.06123)
    ...
    fun `Should display hrd type and brca value when sample is HR deficient`() {
        val brca1Type =
            withHomologousRecombinationStatusAndType(true, hrScore = 0.8123, HrdType.BRCA1_TYPE, brca1Value = 0.75, brca2Value = 0.06123)
        val brca2Type =
            withHomologousRecombinationStatusAndType(true, hrScore = 0.8123, HrdType.BRCA2_TYPE, brca1Value = 0.03123, brca2Value = 0.78)
