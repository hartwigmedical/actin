...
class ActinTrialContentFunctionsTest {
    private val cohort1 = EvaluatedCohort("trial1", "T1", "cohort1", setOf("MSI"), true, true, true, false, setOf("warning1"), emptySet())
    private val cohort2 =
        EvaluatedCohort("trial1", "T1", "cohort2", emptySet(), true, true, true, true, setOf("warning1", "warning2"), emptySet())
