...
class SummaryChapterCRC(private val report: Report) : ReportChapter {
    ...
    private fun addSummaryTable(document: Document) {
        ...
        for (i in generators.indices) {
            ...
            if (generator.title() == "Standard of care options considered potentially eligible") table.addCell(Cells.createKey("As first line treatment, the following standard of care treatment(s) could be an option for this patient. Options are ranked by PFS."))
