...
class RealWorldOSOutcomesGenerator(
    ...
    override fun title(): String {
        return "Median overall survival (months) in NCR real-world data set"
    }
    ...
    override fun contents(): Table {
        return if (eligibleTreatments.isEmpty()) {
            ...
            val content = SOCPersonalizedTableContent.fromPersonalizedDataAnalysis(
                analysis, eligibleTreatments, MeasurementType.OVERALL_SURVIVAL
            ) {
                when {
