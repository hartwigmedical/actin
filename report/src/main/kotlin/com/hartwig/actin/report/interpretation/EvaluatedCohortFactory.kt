            ...
            if (trialMatch.cohorts.isEmpty()) {
                listOf(
                    EvaluatedCohort(
                        ...
                        missingGenesForSufficientEvaluation = trialMatch.evaluations.values.any { it.missingGenesForSufficientEvaluation },
                        isOpen = trialIsOpen,
                ...
                filteredMatches(
                    ...
                    EvaluatedCohort(
                        ...
                        missingGenesForSufficientEvaluation = cohortMatch.evaluations.values.any { it.missingGenesForSufficientEvaluation },
