            ...
            if (trialMatch.cohorts.isEmpty()) {
                listOf(
                    EvaluatedCohort(
                        ...
                        missingGenesForSufficientEvaluation = trialMatch.evaluations.values.flatMap { it.missingGenesForSufficientEvaluation },
                        isOpen = trialIsOpen,
                ...
                filteredMatches(
                    ...
                    EvaluatedCohort(
                        ...
                        missingGenesForSufficientEvaluation = cohortMatch.evaluations.values.flatMap { it.missingGenesForSufficientEvaluation },
