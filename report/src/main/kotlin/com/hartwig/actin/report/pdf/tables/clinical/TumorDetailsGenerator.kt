...
class TumorDetailsGenerator(private val record: PatientRecord, private val keyWidth: Float, private val valueWidth: Float) :
    ...
    private fun Table.createLesionDetails() {
        ...
        with(lesions) {
            createLesionRow("Lesions", nonLymphNodeLesions + lymphNodeLesions + suspectedLesions)
            if (negativeCategories.isNotEmpty()) createLesionRow("No lesions present", negativeCategories)
        }
    }
