...
class PersonalizedEvidenceChapter(private val report: Report, override val include: Boolean) : ReportChapter {
    ...
    override fun render(document: Document) {
        ...
        sequenceOf(
            "‘General’ shows treatment decisions in NCR patients that were diagnosed with colorectal cancer with distant metastases, " +
            ...
            "‘Age’, ‘WHO’, ‘RAS’ and ‘Lesions’ show treatment decisions in the ‘General’ population, plus some patient-specific " +
