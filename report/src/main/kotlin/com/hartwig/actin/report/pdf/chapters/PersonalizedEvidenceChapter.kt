...
import com.hartwig.actin.datamodel.algo.FeatureDistribution
...
class PersonalizedEvidenceChapter(private val report: Report, override val include: Boolean) : ReportChapter {
    ...
    private fun generateFeatureDistributionPlot(
        ...
        val plot = letsPlot(data) +
                geomBar(stat = Stat.identity, position = positionDodge(width = dodgeWidth)) {
                    x = "treatment"
                    y = "proportion"
                    fill = "group"
                } +
