...
An example PDF can be found [here](../system/src/test/resources/example_reports/EXAMPLE-LUNG-01.actin.pdf)
...
- The patient record JSON adheres to datamodel defined
