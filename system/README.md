...
| CRC-01  | An example of a representative CRC patient, intended for externally shared example reports.<br/>Primary: St. IV cecum carcinoma, lung and peritoneal lesions, 1L CAPOX (stop reason: PD). Prior skin squamous cell carcinoma (inactive) <br/>Molecular: KRAS G12D, PD-L1 >50%<br/>                                                                                                                                                                                                                                                                                       |
