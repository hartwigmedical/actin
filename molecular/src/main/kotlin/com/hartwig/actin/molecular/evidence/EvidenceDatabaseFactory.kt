...
object EvidenceDatabaseFactory {
    ...
    fun create(
        ...
        val evidenceFactory = DefaultClinicalEvidenceMatcherFactory(doidModel, tumorDoids, serveRecord.evidences(), serveRecord.trials())
        val knownEventResolver = KnownEventResolverFactory.create(serveRecord.knownEvents())

        return EvidenceDatabase(knownEventResolver, evidenceFactory)
    }
}
