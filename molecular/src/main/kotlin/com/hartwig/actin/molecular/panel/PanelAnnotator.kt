...
class PanelAnnotator(
    ...
    private fun inferredCopyNumber(panelAmplificationExtraction: SequencedAmplification) = CopyNumber(
        ...
        canonicalImpact = TranscriptCopyNumberImpact( //TODO (CB) Question for mr. Duyvesteyn: Is it oke for CDKN2A to only look at canonical for panels? We do have the transcript, so we could check if it is the canonical transcript. But don't know if that too complex.
