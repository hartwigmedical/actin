...
import com.hartwig.actin.molecular.MolecularInterpreterApplication.Companion.LOGGER
...
suspend fun loadInputData(config: MolecularInterpreterConfig, clinicalRefGenomeVersion: RefGenomeVersion): InputData = coroutineScope {
