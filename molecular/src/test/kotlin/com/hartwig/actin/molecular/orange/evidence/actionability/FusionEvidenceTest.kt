...
import com.hartwig.actin.molecular.datamodel.driver.FusionDriverType.PROMISCUOUS_3
import com.hartwig.actin.molecular.datamodel.driver.FusionDriverType.PROMISCUOUS_5
...
class FusionEvidenceTest {
    ...
    fun canDeterminePromiscuousFusionEvidence() {
        ...
        val reportedFusionGene1 = minimalFusion().copy(geneStart = "gene 1", driverType = PROMISCUOUS_5, isReportable = true)
        ...
        val reportedFusionGene2 = minimalFusion().copy(geneEnd = "gene 2", driverType = PROMISCUOUS_3, isReportable = true)
    ...
    fun canDetermineEvidenceForKnownFusions() {
        ...
        val match = minimalFusion().copy(geneStart = "up", geneEnd = "down", fusedExonUp = 5, isReportable = true)
