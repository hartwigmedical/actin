...
class ActionableEvidenceFactoryTest {
    ...
    fun canMapTrials() {
        ...
        assertEquals(evidence.externalEligibleTrials().iterator().next().title(), "On-label responsive trial")
        assertEquals(evidence.externalEligibleTrials().iterator().next().countries(), Sets.newHashSet(Country.OTHER))
        assertEquals(evidence.externalEligibleTrials().iterator().next().url(), "https://clinicaltrials.gov/study/NCT00000001")
        assertEquals(evidence.externalEligibleTrials().iterator().next().nctId(), "NCT00000001")
