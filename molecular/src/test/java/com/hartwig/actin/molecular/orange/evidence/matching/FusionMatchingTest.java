...
public class FusionMatchingTest {

    @Test
    public void canMatchFusions() {
        KnownFusion generic = TestServeKnownFactory.fusionBuilder().geneUp("up").geneDown("down").build();
        KnownFusion exonAware =
        ...
        LinxFusion genericMatch = TestLinxFactory.fusionBuilder().geneStart("up").geneEnd("down").fusedExonUp(0).fusedExonDown(0).build();
        ...
        LinxFusion exactMatch = TestLinxFactory.fusionBuilder().from(genericMatch).fusedExonUp(4).fusedExonDown(6).build();
        ...
        LinxFusion exonUpMatch = TestLinxFactory.fusionBuilder().from(genericMatch).fusedExonUp(3).fusedExonDown(8).build();
        ...
        LinxFusion exonDownMatch = TestLinxFactory.fusionBuilder().from(genericMatch).fusedExonUp(2).fusedExonDown(7).build();
