...
class DriverExtractorTest {
    ...
    fun canCountReportableDrivers() {
        ...
        Assert.assertEquals(2, DriverExtractor.Companion.reportableCount<Driver?>(drivers).toLong())
        Assert.assertEquals(0, DriverExtractor.Companion.reportableCount<Driver?>(Lists.newArrayList<Driver?>()).toLong())
    }
