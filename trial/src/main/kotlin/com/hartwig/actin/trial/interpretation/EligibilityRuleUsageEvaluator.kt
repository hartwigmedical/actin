...
object EligibilityRuleUsageEvaluator {
    ...
    private val UNUSED_RULES_TO_KEEP = setOf(
        ...
        EligibilityRule.HAS_HAD_OBJECTIVE_CLINICAL_BENEFIT_FOLLOWING_NAME_X_TREATMENT,
        ...
        EligibilityRule.HAS_RECEIVED_SYSTEMIC_TREATMENT_FOR_BRAIN_METASTASES,
        ...
        EligibilityRule.HAS_NOT_RECEIVED_ANY_CANCER_TREATMENT_WITHIN_X_MONTHS,
        ...
        EligibilityRule.HAS_PRIMARY_TUMOR_LOCATION_BELONGING_TO_DOID_TERM_X_DISTAL_SUB_LOCATION,
        EligibilityRule.HAS_BONE_METASTASES_ONLY,
        EligibilityRule.IS_ELIGIBLE_FOR_PALLIATIVE_RADIOTHERAPY,
        EligibilityRule.IS_ELIGIBLE_FOR_LOCO_REGIONAL_THERAPY,
        EligibilityRule.HAS_HAD_TREATMENT_NAME_X_COMBINED_WITH_CATEGORY_Y_TREATMENT_OF_TYPES_Z,
        EligibilityRule.HAS_PSMA_POSITIVE_PET_SCAN,
        EligibilityRule.HAS_CALCIUM_MG_PER_DL_OF_AT_MOST_X,
        EligibilityRule.HAS_CORRECTED_CALCIUM_ULN_OF_AT_MOST_X,
        EligibilityRule.HAS_IONIZED_CALCIUM_MMOL_PER_L_OF_AT_MOST_X,
        EligibilityRule.HAS_LDH_ULN_OF_AT_MOST_X,
        EligibilityRule.HAS_PSA_LLN_OF_AT_LEAST_X,
        EligibilityRule.HAS_HISTORY_OF_CENTRAL_NERVOUS_SYSTEM_DISEASE,
        EligibilityRule.HAS_KNOWN_EBV_INFECTION,
        EligibilityRule.HAS_STABLE_ANTICOAGULANT_MEDICATION_DOSING,
        EligibilityRule.HAS_RECEIVED_DRUGS_X_CANCER_THERAPY_WITHIN_Y_WEEKS_Z_HALF_LIVES,
        EligibilityRule.HAS_PULSE_OXIMETRY_OF_AT_LEAST_X,
    )
