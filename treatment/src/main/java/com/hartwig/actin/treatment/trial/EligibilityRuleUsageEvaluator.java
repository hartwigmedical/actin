...
public final class EligibilityRuleUsageEvaluator {
    ...
    static {
        ...
        UNUSED_RULES_TO_KEEP.add(EligibilityRule.MUTATION_IN_GENE_X_OF_ANY_CODING_IMPACTS_Y);
        UNUSED_RULES_TO_KEEP.add(EligibilityRule.HAS_LUNG_METASTASES);
        UNUSED_RULES_TO_KEEP.add(EligibilityRule.HAS_PSA_UG_PER_L_OF_AT_LEAST_X);
