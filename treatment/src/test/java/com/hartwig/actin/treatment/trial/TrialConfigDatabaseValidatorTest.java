...
public class TrialConfigDatabaseValidatorTest {
    ...
    private static TrialConfigDatabase createInvalidTrialConfigDatabase() {
        ...
        ImmutableInclusionCriteriaConfig.Builder inclusionCriterionBuilder =
                ImmutableInclusionCriteriaConfig.builder().reference(Strings.EMPTY).description(Strings.EMPTY);
        ...
        return ImmutableTrialConfigDatabase.builder()
                .addTrialDefinitionConfigs(ImmutableTrialDefinitionConfig.builder()
                        ...
                        .title(Strings.EMPTY)
                        .build())
                .addTrialDefinitionConfigs(ImmutableTrialDefinitionConfig.builder().trialId(trial1).acronym(Strings.EMPTY)
                        .title(Strings.EMPTY)
                        .build())
                .addCohortDefinitionConfigs(ImmutableCohortDefinitionConfig.builder()
                        ...
                        .build())
                .addCohortDefinitionConfigs(ImmutableCohortDefinitionConfig.builder()
                        .trialId(trial1).open(true).cohortId("A").description(Strings.EMPTY).build())
                .addCohortDefinitionConfigs(ImmutableCohortDefinitionConfig.builder()
                        .trialId(trial2)
                        .open(true)
                        .cohortId("A")
                        .description(Strings.EMPTY)
                        .build())
                .addInclusionCriteriaConfigs(inclusionCriterionBuilder.trialId(trial1)
                        .addAppliesToCohorts("B")
                        .inclusionCriterion(EligibilityRule.IS_AT_LEAST_18_YEARS_OLD.toString())
                        .build())
                .addInclusionCriteriaConfigs(inclusionCriterionBuilder.trialId(trial2)
