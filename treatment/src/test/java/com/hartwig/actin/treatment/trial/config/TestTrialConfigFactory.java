...
public final class TestTrialConfigFactory {
    ...
    private static List<CohortDefinitionConfig> createTestCohortDefinitionConfigs() {
        ...
        configs.add(builder.cohortId("A").open(true).blacklist(false).description("Cohort A").build());
        configs.add(builder.cohortId("B").open(true).blacklist(true).description("Cohort B").build());
        configs.add(builder.cohortId("C").open(false).blacklist(false).description("Cohort C").build());
