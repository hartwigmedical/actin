...
enum class LabMeasurement(val display: String, val defaultUnit: LabUnit) : Displayable {
    ...
    FREE_T3("Free T3", LabUnit.PICOMOLES_PER_LITER),
    FREE_T4("Free T4", LabUnit.PICOMOLES_PER_LITER),
    ...
    HCO3_A("Act. bicarbonate", LabUnit.MILLIMOLES_PER_LITER),
    HCO3_A_BG("Act. bicarbonate (blood gas)", LabUnit.MILLIMOLES_PER_LITER),
    HCO3_S_BG("Standard bicarbonate (blood gas)", LabUnit.MILLIMOLES_PER_LITER),
    ...
    IONIZED_CALCIUM_74("Ionized calcium 7.4", LabUnit.MILLIMOLES_PER_LITER),
    ...
    BOUND_T3( "Bound T3", LabUnit.NANOMOLES_PER_LITER),
    ...
    THYROID_STIMULATING_HORMONE( "Thyroid stimulating hormone", LabUnit.MILLIUNITS_PER_LITER),
    ...
    WHITE_BLOOD_COUNT( "Leukocytes", LabUnit.MILLIONS_PER_LITER),
    WHITE_BLOOD_COUNT_LQ( "Leukocytes in liquor", LabUnit.BILLIONS_PER_LITER),
