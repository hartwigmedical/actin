...
enum class EligibilityRule(val input: FunctionInput?) {
    ...
    CURRENTLY_IS_TREATED_WITH_ANY_DRUG_X(FunctionInput.MANY_DRUGS),
    ...
    CURRENTLY_GETS_MEDICATION_SUBSTRATE_OF_OATP1B1B3(FunctionInput.NONE),
