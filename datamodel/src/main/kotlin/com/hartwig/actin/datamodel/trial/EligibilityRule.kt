...
enum class EligibilityRule(val input: FunctionInput?, val ihcProtein: String? = null) {
    ...
    HAS_DRIVER_EVENT_WITH_APPROVED_THERAPY_AVAILABLE(FunctionInput.NONE),
    HAS_DRIVER_EVENT_IN_ANY_GENES_X_WITH_APPROVED_THERAPY_AVAILABLE(FunctionInput.MANY_GENES),
