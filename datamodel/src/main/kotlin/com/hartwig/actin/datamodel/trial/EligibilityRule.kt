...
enum class EligibilityRule(val input: FunctionInput?) {
    ...
    HAS_TOXICITY_CTCAE_OF_AT_LEAST_GRADE_X_IN_ANY_OF_Y(FunctionInput.ONE_INTEGER_MANY_ICD_TITLES),
    HAS_TOXICITY_ASTCT_OF_AT_LEAST_GRADE_X_IN_ANY_OF_Y(FunctionInput.ONE_INTEGER_MANY_ICD_TITLES),
    HAS_TOXICITY_CTCAE_OF_AT_LEAST_GRADE_X_IGNORING_Y(FunctionInput.ONE_INTEGER_MANY_ICD_TITLES),
