...
enum class EligibilityRule(val input: FunctionInput?) {
    ...
    EXPRESSION_OF_PROTEIN_X_BY_IHC_OF_EXACTLY_Y(FunctionInput.TWO_STRINGS_ONE_INTEGER),
    EXPRESSION_OF_PROTEIN_X_BY_IHC_OF_AT_LEAST_Y(FunctionInput.TWO_STRINGS_ONE_INTEGER),
    EXPRESSION_OF_PROTEIN_X_BY_IHC_OF_AT_MOST_Y(FunctionInput.TWO_STRINGS_ONE_INTEGER),
