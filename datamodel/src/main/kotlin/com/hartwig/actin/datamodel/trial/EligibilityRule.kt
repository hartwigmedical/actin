...
enum class EligibilityRule(val input: FunctionInput?) {
    ...
    HAS_LESION_COUNT_OF_AT_LEAST_X_IN_BODY_LOCATION_Y(FunctionInput.ONE_INTEGER_ONE_STRING),
    ...
    HAS_HAD_PLATINUM_BASED_CHEMOTHERAPY_COMBINED_WITH_CATEGORY_X_TREATMENT_OF_TYPES_Y(FunctionInput.ONE_TREATMENT_CATEGORY_MANY_TYPES),
    ...
    LOSS_OF_PROTEIN_X_BY_IHC(FunctionInput.ONE_STRING),
    ...
    HAS_CD4_POSITIVE_CELLS_PER_MICROLITER_OF_AT_LEAST_X(FunctionInput.ONE_DOUBLE),
    ...
    HAS_TOXICITY_CTCAE_OF_AT_LEAST_GRADE_X_IN_Y(FunctionInput.ONE_INTEGER_ONE_STRING),
    HAS_TOXICITY_ASTCT_OF_AT_LEAST_GRADE_X_IN_Y(FunctionInput.ONE_INTEGER_ONE_STRING),
    HAS_TOXICITY_CTCAE_OF_AT_LEAST_GRADE_X_IGNORING_Y(FunctionInput.ONE_INTEGER_MANY_STRINGS),
