...
enum class EligibilityRule(val input: FunctionInput?) {
    ...
    IS_ELIGIBLE_FOR_LUNG_SURGERY(FunctionInput.NONE),
    ...
    CURRENTLY_GETS_MEDICATION_INHIBITING_BCRP(FunctionInput.NONE),
    CURRENTLY_GETS_MEDICATION_SUBSTRATE_OF_BCRP(FunctionInput.NONE),
    CURRENTLY_GETS_MEDICATION_SUBSTRATE_OF_OATP1B1(FunctionInput.NONE),
    CURRENTLY_GETS_MEDICATION_SUBSTRATE_OF_OATP1B3(FunctionInput.NONE),
    CURRENTLY_GETS_MEDICATION_SUBSTRATE_OR_INHIBITING_ANY_TYPE_X(FunctionInput.MANY_STRINGS),
