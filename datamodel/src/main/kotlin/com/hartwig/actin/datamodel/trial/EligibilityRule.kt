...
enum class EligibilityRule(val input: FunctionInput?) {
    ...
    LOSS_OF_PROTEIN_X_OF_GENE_Y_BY_IHC(FunctionInput.TWO_STRINGS),
    EXPRESSION_OF_PROTEIN_X_OF_GENE_Y_BY_IHC(FunctionInput.TWO_STRINGS),
    EXPRESSION_OF_PROTEIN_X_OF_GENE_Y_BY_IHC_OF_EXACTLY_Z(FunctionInput.TWO_STRINGS_ONE_INTEGER),
    EXPRESSION_OF_PROTEIN_X_OF_GENE_Y_BY_IHC_OF_AT_LEAST_Z(FunctionInput.TWO_STRINGS_ONE_INTEGER),
    EXPRESSION_OF_PROTEIN_X_OF_GENE_Y_BY_IHC_OF_AT_MOST_Z(FunctionInput.TWO_STRINGS_ONE_INTEGER),
