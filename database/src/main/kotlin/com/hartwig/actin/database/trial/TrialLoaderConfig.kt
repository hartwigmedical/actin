...
interface TrialLoaderConfig : DatabaseLoaderConfig {
    fun trialDatabaseDirectory(): String
    ...
    companion object {
        ...
        val LOGGER = LogManager.getLogger(TrialLoaderConfig::class.java)
        const val TRIAL_DATABASE_DIRECTORY = "trial_database_directory"
