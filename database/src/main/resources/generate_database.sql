...
(   id int NOT NULL AUTO_INCREMENT,
    ...
    categories varchar(100) NOT NULL,
    chemicalSubgroupAtc varchar(100) NOT NULL,
    pharmacologicalSubgroupAtc varchar(100) NOT NULL,
    therapeuticSubgroupAtc varchar(100) NOT NULL,
    anatomicalMainGroupAtc varchar(100) NOT NULL,
    status varchar(50),
