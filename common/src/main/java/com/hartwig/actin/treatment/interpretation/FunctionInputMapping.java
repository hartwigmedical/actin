...
final class FunctionInputMapping {
    ...
    static {
        ...
        RULE_INPUT_MAP.put(EligibilityRule.HAS_HAD_CATEGORY_X_TREATMENT_OF_TYPES_Y_AND_AT_MOST_Z_LINES,
                FunctionInput.ONE_TREATMENT_CATEGORY_MANY_STRINGS_ONE_INTEGER);
        ...
        RULE_INPUT_MAP.put(EligibilityRule.HAS_RECEIVED_HERBAL_MEDICATION_OR_DIETARY_SUPPLEMENTS_WITHIN_X_WEEKS, FunctionInput.NONE);
