...
internal object FunctionInputMapping {
    @JvmField
    val RULE_INPUT_MAP: Map<EligibilityRule, FunctionInput> = Maps.newHashMap()
    ...
    init {
        ...
        RULE_INPUT_MAP.put(
            EligibilityRule.HAS_HAD_CATEGORY_X_TREATMENT_OF_TYPES_Y_WITHIN_Z_WEEKS,
        ...
        RULE_INPUT_MAP.put(
            EligibilityRule.HAS_HAD_CATEGORY_X_TREATMENT_AND_AT_MOST_Y_LINES,
            FunctionInput.ONE_TREATMENT_CATEGORY_OR_TYPE_ONE_INTEGER
        )
        RULE_INPUT_MAP.put(
            EligibilityRule.HAS_HAD_CATEGORY_X_TREATMENT_OF_TYPES_Y_AND_AT_LEAST_Z_LINES,
            FunctionInput.ONE_TREATMENT_CATEGORY_MANY_TYPES_ONE_INTEGER
        )
        RULE_INPUT_MAP.put(
            EligibilityRule.HAS_HAD_CATEGORY_X_TREATMENT_OF_TYPES_Y_AND_AT_MOST_Z_LINES,
            FunctionInput.ONE_TREATMENT_CATEGORY_MANY_TYPES_ONE_INTEGER
        )
        ...
        RULE_INPUT_MAP.put(
            EligibilityRule.HAS_PROGRESSIVE_DISEASE_FOLLOWING_CATEGORY_X_TREATMENT,
            FunctionInput.ONE_TREATMENT_CATEGORY_OR_TYPE
        )
        RULE_INPUT_MAP.put(
            EligibilityRule.HAS_PROGRESSIVE_DISEASE_FOLLOWING_CATEGORY_X_TREATMENT_OF_TYPES_Y,
            FunctionInput.ONE_TREATMENT_CATEGORY_MANY_TYPES
        )
        RULE_INPUT_MAP.put(
        ...
        RULE_INPUT_MAP.put(
            EligibilityRule.HAS_CUMULATIVE_ANTHRACYCLINE_EXPOSURE_OF_AT_MOST_X_MG_PER_M2_DOXORUBICIN_OR_EQUIVALENT,
        ...
        RULE_INPUT_MAP.put(
            EligibilityRule.HAS_RECEIVED_CATEGORIES_X_CANCER_THERAPY_WITHIN_Y_WEEKS_Z_HALF_LIVES,
            FunctionInput.MANY_STRINGS_TWO_INTEGERS
        )
        ...
        RULE_INPUT_MAP.put(
            EligibilityRule.HAS_RECEIVED_ANY_ANTI_CANCER_THERAPY_EXCL_CATEGORIES_X_WITHIN_Y_WEEKS,
        ...
        RULE_INPUT_MAP.put(
            EligibilityRule.HAS_RECEIVED_ANY_ANTI_CANCER_THERAPY_EXCL_CATEGORIES_X_WITHIN_Y_WEEKS_Z_HALF_LIVES,
            FunctionInput.MANY_STRINGS_TWO_INTEGERS
        )
