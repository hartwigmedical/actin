...
public enum EligibilityRule {
    ...
    HAS_PROSTATE_CANCER_WITH_SMALL_CELL_HISTOLOGY,
    ...
    CAN_PROVIDE_ARCHIVAL_OR_NEW_TISSUE_SAMPLE_FOR_FFPE_ANALYSIS,
    HAS_ASSESSABLE_DISEASE,
    ...
    HAS_HAD_CATEGORY_X_TREATMENT_OF_TYPES_Y_WITH_STOP_REASON_PD,
    ...
    CURRENTLY_GETS_MEDICATION_INHIBITING_OR_INDUCING_DRUG_METABOLIZING_ENZYMES,
    ...
    HAS_URINARY_INCONTINENCE,
    HAS_BLADDER_OUTFLOW_OBSTRUCTION,

    // Rules related to allergies/toxicities
    HAS_INTOLERANCE_TO_NAME_X,
    HAS_INTOLERANCE_BELONGING_TO_DOID_X,
