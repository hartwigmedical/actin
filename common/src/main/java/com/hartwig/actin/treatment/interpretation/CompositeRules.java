...
public final class CompositeRules {
    ...
    static {
        ...
        COMPOSITE_RULE_MAPPING.put(EligibilityRule.NOT, CompositeInput.MAXIMUM_1);
        COMPOSITE_RULE_MAPPING.put(EligibilityRule.WARN_ON_PASS, CompositeInput.MAXIMUM_1);
    }
