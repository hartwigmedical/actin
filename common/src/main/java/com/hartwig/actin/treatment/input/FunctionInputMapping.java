...
final class FunctionInputMapping {
    ...
    static {
        ...
        RULE_INPUT_MAP.put(EligibilityRule.HAS_HAD_CATEGORY_X_TREATMENT_OF_TYPE_Y, FunctionInput.ONE_TREATMENT_ONE_STRING);
        RULE_INPUT_MAP.put(EligibilityRule.HAS_HAD_CATEGORY_X_TREATMENT_IGNORING_TYPE_Y, FunctionInput.ONE_TREATMENT_MANY_STRINGS);
        RULE_INPUT_MAP.put(EligibilityRule.HAS_HAD_CATEGORY_X_TREATMENT_AND_AT_LEAST_Y_LINES,
                FunctionInput.ONE_TREATMENT_ONE_INTEGER);
        ...
        RULE_INPUT_MAP.put(EligibilityRule.HAS_HAD_CATEGORY_X_TREATMENT_OF_TYPE_Y_AND_AT_LEAST_Z_LINES,
                FunctionInput.ONE_TREATMENT_ONE_STRING_ONE_INTEGER);
        ...
        RULE_INPUT_MAP.put(EligibilityRule.HAS_HAD_CATEGORY_X_TREATMENT_OF_TYPES_Y_AND_AT_MOST_Z_LINES,
                FunctionInput.ONE_TREATMENT_MANY_STRINGS_ONE_INTEGER);
