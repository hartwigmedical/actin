...
final class FunctionInputMapping {
    ...
    static {
        ...
        RULE_INPUT_MAP.put(EligibilityRule.HAS_HAD_SYSTEMIC_THERAPY_WITH_ANY_INTENT_X_WITHIN_Y_MONTHS, FunctionInput.MANY_INTENTS_WITH_ONE_INTEGER);
        ...
        RULE_INPUT_MAP.put(EligibilityRule.HAS_UGT1A1_HAPLOTYPE_X, FunctionInput.ONE_HAPLOTYPE);
        RULE_INPUT_MAP.put(EligibilityRule.HAS_HOMOZYGOUS_DPYD_DEFICIENCY, FunctionInput.NONE);
