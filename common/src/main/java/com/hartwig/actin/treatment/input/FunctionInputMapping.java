...
final class FunctionInputMapping {
    ...
    static {
        ...
        RULE_INPUT_MAP.put(EligibilityRule.MUTATION_IN_GENE_X_IN_ANY_CODONS_Y, FunctionInput.ONE_STRING_MANY_STRINGS);
        ...
        RULE_INPUT_MAP.put(EligibilityRule.MOLECULAR_TEST_MUST_HAVE_BEEN_DONE_FOR_GENE_X, FunctionInput.ONE_STRING);
        RULE_INPUT_MAP.put(EligibilityRule.MOLECULAR_TEST_MUST_HAVE_BEEN_DONE_FOR_PROMOTER_OF_GENE_X, FunctionInput.ONE_STRING);
