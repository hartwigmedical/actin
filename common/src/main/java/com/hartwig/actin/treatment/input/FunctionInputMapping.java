...
final class FunctionInputMapping {
    ...
    static {
        ...
        RULE_INPUT_MAP.put(EligibilityRule.HAS_RECEIVED_DRUGS_X_CANCER_THERAPY_WITHIN_Y_WEEKS, FunctionInput.ONE_STRING_ONE_INTEGER);
        RULE_INPUT_MAP.put(EligibilityRule.HAS_RECEIVED_DRUGS_X_CANCER_THERAPY_WITHIN_Y_WEEKS_Z_HALF_LIVES, FunctionInput.MANY_STRINGS_TWO_INTEGERS);
        RULE_INPUT_MAP.put(EligibilityRule.HAS_RECEIVED_CATEGORIES_X_CANCER_THERAPY_WITHIN_Y_WEEKS, FunctionInput.ONE_STRING_ONE_INTEGER);
        RULE_INPUT_MAP.put(EligibilityRule.HAS_RECEIVED_CATEGORIES_X_CANCER_THERAPY_WITHIN_Y_WEEKS_Z_HALF_LIVES, FunctionInput.MANY_STRINGS_TWO_INTEGERS);
