...
public final class EligibilityParameterResolver {
    ...
    static {
        ...
        RULES_WITHOUT_PARAMETERS.add(EligibilityRule.HAS_CONTRAINDICATION_FOR_EXHAUSTING_SOC_TREATMENTS);
        RULES_WITHOUT_PARAMETERS.add(EligibilityRule.HAS_UNAVAILABILITY_FOR_EXHAUSTING_SOC_TREATMENTS);
        ...
        RULES_WITH_ONE_INTEGER_PARAMETER.add(EligibilityRule.SECOND_MALIGNANCY_HAS_BEEN_CURED_SINCE_X_YEARS);
        ...
        RULES_WITH_ONE_DOUBLE_PARAMETER.add(EligibilityRule.HAS_THROMBOCYTES_ABS_AT_LEAST_X);
        ...
        RULES_WITH_ONE_DOUBLE_PARAMETER.add(EligibilityRule.HAS_TOTAL_BILIRUBIN_ULN_AT_MOST_X);
        RULES_WITH_ONE_DOUBLE_PARAMETER.add(EligibilityRule.HAS_DIRECT_BILIRUBIN_ULN_AT_MOST_X);
        RULES_WITH_ONE_DOUBLE_PARAMETER.add(EligibilityRule.HAS_INR_ULN_AT_MOST_X);
        RULES_WITH_ONE_DOUBLE_PARAMETER.add(EligibilityRule.HAS_PT_ULN_AT_MOST_X);
        RULES_WITH_ONE_DOUBLE_PARAMETER.add(EligibilityRule.HAS_APTT_ULN_AT_MOST_X);
        ...
        RULES_WITH_ONE_DOUBLE_PARAMETER.add(EligibilityRule.HAS_KNOWN_LVEF_OF_AT_LEAST_X);
