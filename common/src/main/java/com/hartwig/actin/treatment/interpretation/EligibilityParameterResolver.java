...
public final class EligibilityParameterResolver {
    ...
    static {
        ...
        RULES_WITH_ONE_STRING_PARAMETER.add(EligibilityRule.HAS_HAD_TYPE_X_TREATMENT);
        ...
        RULES_WITH_ONE_INTEGER_PARAMETER.add(EligibilityRule.HAS_RECEIVED_ATTENUATED_VACCINE_X_DAYS_BEFORE_STUDY_TREATMENT);
