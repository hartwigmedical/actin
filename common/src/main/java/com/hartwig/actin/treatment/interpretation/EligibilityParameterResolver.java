...
public final class EligibilityParameterResolver {
    ...
    static {
        ...
        RULES_WITH_ONE_DOUBLE_PARAMETER.add(EligibilityRule.HAS_SBP_MMHG_OF_AT_MOST_X);
        RULES_WITH_ONE_DOUBLE_PARAMETER.add(EligibilityRule.HAS_DBP_MMHG_OF_AT_MOST_X);
