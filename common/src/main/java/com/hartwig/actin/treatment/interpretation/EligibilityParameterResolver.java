...
public final class EligibilityParameterResolver {
    ...
    static {
        ...
        PARAMETER_MAP.put(EligibilityRule.HAS_HAD_FLUOROPYRIMIDINE_TREATMENT, Inputs.NONE);
        ...
        PARAMETER_MAP.put(EligibilityRule.HAS_HISTORY_OF_SPECIFIC_CONDITION_WITH_DOID_X, Inputs.ONE_STRING);
        ...
        PARAMETER_MAP.put(EligibilityRule.CURRENTLY_GETS_MEDICATION, Inputs.NONE);
        ...
        PARAMETER_MAP.put(EligibilityRule.CURRENTLY_GETS_MEDICATION_INHIBITING_OR_INDUCING_CYP_X, Inputs.ONE_STRING);
        PARAMETER_MAP.put(EligibilityRule.CURRENTLY_GETS_MEDICATION_INHIBITING_OR_INDUCING_PGP, Inputs.NONE);
        ...
        PARAMETER_MAP.put(EligibilityRule.IS_PARTICIPATING_IN_ANOTHER_TRIAL, Inputs.NONE);
