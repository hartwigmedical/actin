...
public final class EligibilityParameterResolver {
    ...
    static {
        ...
        RULES_WITH_ONE_STRING_PARAMETER.add(EligibilityRule.HAS_HAD_DRUG_TYPE_X_TREATMENT);
        RULES_WITH_ONE_STRING_PARAMETER.add(EligibilityRule.HAS_HAD_TARGETED_THERAPY_TREATMENT_TARGETING_GENE_X);
