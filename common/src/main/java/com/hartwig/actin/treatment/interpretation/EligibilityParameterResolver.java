...
public final class EligibilityParameterResolver {
    ...
    static {
        ...
        RULES_WITH_SINGLE_STRING_PARAMETER.add(EligibilityRule.ACTIVATION_OF_GENE_X);
        RULES_WITH_SINGLE_STRING_PARAMETER.add(EligibilityRule.INACTIVATION_OF_GENE_X);
        RULES_WITH_SINGLE_STRING_PARAMETER.add(EligibilityRule.ACTIVATING_MUTATION_IN_GENE_X);
        // TODO
        RULES_WITH_SINGLE_STRING_PARAMETER.add(EligibilityRule.ACTIVATING_MUTATION_IN_GENE_X_AND_SPECIFIC_MUTATION_Y);
        RULES_WITH_SINGLE_STRING_PARAMETER.add(EligibilityRule.INACTIVATING_MUTATION_IN_GENE_X);
        RULES_WITH_SINGLE_STRING_PARAMETER.add(EligibilityRule.AMPLIFICATION_OF_GENE_X);
        RULES_WITH_SINGLE_STRING_PARAMETER.add(EligibilityRule.DELETION_OF_GENE_X);
        RULES_WITH_SINGLE_STRING_PARAMETER.add(EligibilityRule.ACTIVATING_FUSION_IN_GENE_X);
        RULES_WITH_SINGLE_STRING_PARAMETER.add(EligibilityRule.WILDTYPE_OF_GENE_X);
        RULES_WITHOUT_PARAMETERS.add(EligibilityRule.MSI_SIGNATURE);
        RULES_WITHOUT_PARAMETERS.add(EligibilityRule.HRD_SIGNATURE);
        RULES_WITH_SINGLE_INTEGER_PARAMETER.add(EligibilityRule.TMB_OF_AT_LEAST_X);
        RULES_WITH_SINGLE_INTEGER_PARAMETER.add(EligibilityRule.TML_OF_AT_LEAST_X);
        ...
        RULES_WITH_SINGLE_DOUBLE_PARAMETER.add(EligibilityRule.HAS_EGFR_CKD_EPI_OF_AT_LEAST_X);
        RULES_WITH_SINGLE_DOUBLE_PARAMETER.add(EligibilityRule.HAS_EGFR_MDRD_OF_AT_LEAST_X);
        ...
        RULES_WITH_SINGLE_DOUBLE_PARAMETER.add(EligibilityRule.HAS_KNOWN_LVEF_OF_AT_MOST_X);
