...
object DoidManualConfigFactory {
    private val MAIN_CANCER_DOIDS: MutableSet<String> = Sets.newHashSet()
    private val ADENO_SQUAMOUS_MAPPINGS: MutableSet<AdenoSquamousMapping> = Sets.newHashSet()
    private val ADDITIONAL_DOIDS_PER_DOID: MutableMap<String, String> = Maps.newHashMap()
    ...
    init {
        ...
        ADDITIONAL_DOIDS_PER_DOID["4829"] = "3908" // Lung adenosquamous > NSCLC
        ADDITIONAL_DOIDS_PER_DOID["6438"] = "6039" // Malignant choroid melanoma > Uveal melanoma
        ADDITIONAL_DOIDS_PER_DOID["7807"] = "6039" // Choroid necrotic melanoma > Uveal melanoma
        ADDITIONAL_DOIDS_PER_DOID["6994"] = "6039" // Iris melanoma > Uveal melanoma
        ADDITIONAL_DOIDS_PER_DOID["6524"] = "6039" // Ciliary body melanoma > Uveal melanoma
        ADDITIONAL_DOIDS_PER_DOID["6039"] = "1752" // Uveal melanoma > Ocular melanoma
        ADDITIONAL_DOIDS_PER_DOID["1751"] = "1752" // Malignant conjunctival melanoma > Ocular melanoma
        ADDITIONAL_DOIDS_PER_DOID["234"] = "0050861" // Colon adenocarcinoma > Colorectal adenocarcinoma
        ADDITIONAL_DOIDS_PER_DOID["1996"] = "0050861" // Rectum adenocarcinoma > Colorectal adenocarcinoma
        ADDITIONAL_DOIDS_PER_DOID["1520"] = "0080199" // Colon carcinoma > Colorectal carcinoma
    }
    ...
    private fun createMapping(
        adenoSquamousDoid: String, squamousDoid: String,
        adenoDoid: String
    ): AdenoSquamousMapping {
