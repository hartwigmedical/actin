...
object MolecularRecordJson {
    ...
    fun fromJson(json: String): MolecularRecord {
        ...
        return gson.fromJson<MolecularRecord>(json, MolecularRecord::class.java)
    }
        ...
        companion object {
            ...
            private fun toPredictedTumorOrigin(predictedTumorOrigin: JsonObject?): PredictedTumorOrigin? {
                return if (predictedTumorOrigin == null) {
                    ...
                    .predictions(
                        extractListFromJson(array(predictedTumorOrigin, "predictions"),
                            Function<JsonObject, T> { prediction: JsonObject? ->
                ...
                for (element in variantArray) {
                    ...
                    variants.add(
                        ImmutableVariant.builder()
                            ...
                            .otherImpacts(
                                extractSetFromJson(
                                    array(variant, "otherImpacts"),
                                    Function<JsonObject, T> { impact: JsonObject -> toTranscriptImpact(impact) })
                            )
                            .build()
                    )
                }
