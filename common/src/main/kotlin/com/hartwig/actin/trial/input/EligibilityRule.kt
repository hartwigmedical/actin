...
enum class EligibilityRule(val input: List<Parameter.Type>) {
    ...
    HAS_MOUTH_OPENING_OF_AT_LEAST_X_MM(FunctionInput.ONE_INTEGER),
    ...
    HAS_PRIMARY_TUMOR_LOCATION_BELONGING_TO_ANY_DOID_TERM_X_WITH_SUB_LOCATION_Y(FunctionInput.MANY_DOID_TERMS_ONE_STRING),
    ...
    HAS_CANCER_WITH_LARGE_CELL_COMPONENT(FunctionInput.NONE),
    HAS_LOW_GRADE_CANCER(FunctionInput.NONE),
    HAS_HIGH_GRADE_CANCER(FunctionInput.NONE),
    HAS_WELL_DIFFERENTIATED_TUMOR(FunctionInput.NONE),
    ...
    HAS_NON_MUSCLE_INVASIVE_BLADDER_CANCER(FunctionInput.NONE),
    ...
    MEETS_SPECIFIC_CRITERIA_REGARDING_RECURRENT_CANCER(FunctionInput.NONE),
    HAS_INCURABLE_CANCER(FunctionInput.NONE),
    HAS_PRIMARY_TUMOR_AT_UNFAVOURABLE_SITE(FunctionInput.NONE),
    ...
    HAS_LIVER_AND_OR_LYMPH_NODE_AND_OR_LUNG_METASTASES_ONLY(FunctionInput.NONE),
    HAS_KNOWN_CNS_METASTASES(FunctionInput.NONE),
    HAS_ACTIVE_CNS_METASTASES(FunctionInput.NONE),
    HAS_SYMPTOMATIC_CNS_METASTASES(FunctionInput.NONE),
    HAS_KNOWN_BRAIN_METASTASES(FunctionInput.NONE),
    HAS_ACTIVE_BRAIN_METASTASES(FunctionInput.NONE),
    HAS_SYMPTOMATIC_BRAIN_METASTASES(FunctionInput.NONE),
    ...
    HAS_IN_TRANSIT_METASTASES(FunctionInput.NONE),
    HAS_SPLEEN_METASTASES(FunctionInput.NONE),
    HAS_SOFT_TISSUE_METASTASES(FunctionInput.NONE),
    ...
    HAS_EXTENSIVE_ABDOMINAL_TUMOR_SPREAD(FunctionInput.NONE),
    HAS_BIOPSY_AMENABLE_LESION(FunctionInput.NONE),
    HAS_IRRADIATION_AMENABLE_LESION(FunctionInput.NONE),
    HAS_HIFU_AMENABLE_LESION(FunctionInput.NONE),
    HAS_PRESENCE_OF_LESIONS_IN_AT_LEAST_X_SITES(FunctionInput.ONE_INTEGER),
    HAS_RISK_OF_AT_LEAST_X_PERCENTAGE_FOR_SENTINEL_NODE_POSITIVITY(FunctionInput.ONE_INTEGER),
    HAS_OLIGOPROGRESSIVE_DISEASE(FunctionInput.NONE),
    ...
    HAS_VISIBLE_LESION_BY_CYSTOSCOPY(FunctionInput.NONE),
    ...
    HAS_MEASURABLE_DISEASE_PERCIST(FunctionInput.NONE),
    ...
    HAS_SIEWERT_TYPE_X(FunctionInput.ONE_STRING),
    HAS_ANY_RISK_X_CANCER(FunctionInput.MANY_STRINGS),
    HAS_MODIFIED_OBERLIN_PROGNOSTIC_SCORE_OF_AT_LEAST_X(FunctionInput.ONE_INTEGER),
    HAS_LEFT_SIDED_COLORECTAL_TUMOR(FunctionInput.NONE),
    HAS_SYMPTOMS_OF_PRIMARY_TUMOR_IN_SITU(FunctionInput.NONE),
    HAS_TUMOR_LENGTH_OF_AT_MOST_X_CM(FunctionInput.ONE_INTEGER),
    ...
    IS_ELIGIBLE_FOR_ON_LABEL_TREATMENT_X_WITH_INTENT_Y(FunctionInput.ONE_SPECIFIC_TREATMENT_ONE_INTENT),
    ...
    HAS_HAD_AT_LEAST_X_SYSTEMIC_TREATMENT_LINES_ONLY_INCLUDING_NEO_OR_ADJUVANT_IF_NEXT_LINE_WITHIN_Y_MONTHS(FunctionInput.TWO_INTEGERS),
    HAS_HAD_AT_MOST_X_SYSTEMIC_TREATMENT_LINES_ONLY_INCLUDING_NEO_OR_ADJUVANT_IF_NEXT_LINE_WITHIN_Y_MONTHS(FunctionInput.TWO_INTEGERS),
    HAS_HAD_ANY_CANCER_TREATMENT(FunctionInput.NONE),
    HAS_HAD_ANY_CANCER_TREATMENT_IGNORING_CATEGORIES_X(FunctionInput.MANY_TREATMENT_CATEGORIES),
    HAS_HAD_ANY_CANCER_TREATMENT_IGNORING_CATEGORY_X_OF_TYPES_Y_WITHIN_Z_MONTHS(FunctionInput.ONE_TREATMENT_CATEGORY_MANY_TYPES_ONE_INTEGER),
    ...
    HAS_HAD_TREATMENT_NAME_X_FOR_AT_MOST_Y_WEEKS(FunctionInput.ONE_SPECIFIC_TREATMENT_ONE_INTEGER),
    HAS_HAD_TREATMENT_NAME_X_FOR_AT_LEAST_Y_WEEKS(FunctionInput.ONE_SPECIFIC_TREATMENT_ONE_INTEGER),
    HAS_HAD_DOSE_REDUCTION_DURING_TREATMENT_NAME_X(FunctionInput.ONE_SPECIFIC_TREATMENT),
    HAS_HAD_DOSE_REDUCTION_DURING_TREATMENT_WITH_DRUG_X(FunctionInput.ONE_SPECIFIC_DRUG),
    HAS_HAD_FIRST_LINE_SYSTEMIC_TREATMENT_NAME_X(FunctionInput.ONE_SPECIFIC_TREATMENT),
    HAS_HAD_FIRST_LINE_SYSTEMIC_TREATMENT_NAME_X_WITHOUT_PROGRESSION_AND_AT_LEAST_Y_CYCLES(FunctionInput.ONE_SPECIFIC_TREATMENT_ONE_INTEGER),
    ...
    HAS_HAD_DRUG_X_COMBINED_WITH_CATEGORY_Y_TREATMENT_OF_TYPES_Z_AS_A_LINE(FunctionInput.ONE_SPECIFIC_DRUG_ONE_TREATMENT_CATEGORY_MANY_TYPES_ONE_INTEGER),
    HAS_HAD_DRUG_X_COMBINED_WITH_CATEGORY_Y_TREATMENT_OF_TYPES_Z_AND_AT_LEAST_A_CYCLES(FunctionInput.ONE_SPECIFIC_DRUG_ONE_TREATMENT_CATEGORY_MANY_TYPES_ONE_INTEGER),
    ...
    HAS_HAD_TREATMENT_WITH_ANY_DRUG_X_AND_AT_LEAST_Y_CYCLES(FunctionInput.MANY_DRUGS_ONE_INTEGER),
    HAS_HAD_TREATMENT_WITH_ANY_DRUG_X_AS_MOST_RECENT_LINE(FunctionInput.MANY_DRUGS),
    CURRENTLY_GETS_TREATMENT_WITH_ANY_DRUG_X(FunctionInput.MANY_DRUGS),
    HAS_HAD_COMBINED_TREATMENT_NAMES_X_AND_BETWEEN_Y_AND_Z_CYCLES(FunctionInput.MANY_SPECIFIC_TREATMENTS_TWO_INTEGERS),
    HAS_HAD_TREATMENT_NAME_X_AND_AT_LEAST_Y_CYCLES(FunctionInput.ONE_SPECIFIC_TREATMENT_ONE_INTEGER),
    ...
    HAS_HAD_CATEGORY_X_TREATMENT_WITHIN_Z_WEEKS(FunctionInput.ONE_TREATMENT_CATEGORY_OR_TYPE_ONE_INTEGER),
    ...
    HAS_HAD_CATEGORY_X_TREATMENT_OF_TYPES_Y_FOR_AT_LEAST_Z_WEEKS(FunctionInput.ONE_TREATMENT_CATEGORY_MANY_TYPES_ONE_INTEGER),
    ...
    HAS_HAD_CATEGORY_X_TREATMENT_OF_ANY_TYPE_Y_WITH_ANY_INTENT_Z(FunctionInput.ONE_TREATMENT_CATEGORY_MANY_TYPES_MANY_INTENTS),
    ...
    HAS_HAD_SYSTEMIC_TREATMENT_IN_METASTATIC_SETTING(FunctionInput.NONE),
    HAS_HAD_SYSTEMIC_TREATMENT_IN_METASTATIC_SETTING_EXCLUDING_CATEGORY_X(FunctionInput.ONE_TREATMENT_CATEGORY_OR_TYPE),
    HAS_HAD_SYSTEMIC_TREATMENT_IN_ADVANCED_OR_METASTATIC_SETTING(FunctionInput.NONE),
    HAS_HAD_AT_MOST_X_SYSTEMIC_TREATMENT_LINES_IN_THE_METASTATIC_SETTING(FunctionInput.ONE_INTEGER),
    HAS_HAD_AT_MOST_X_SYSTEMIC_TREATMENT_LINES_IN_THE_ADVANCED_OR_METASTATIC_SETTING(FunctionInput.ONE_INTEGER),
    HAS_HAD_RESPONSE_X_FOLLOWING_CATEGORY_Y_TREATMENT_OF_TYPES_Z(FunctionInput.ONE_TREATMENT_RESPONSE_ONE_TREATMENT_CATEGORY_MANY_TYPES),
    HAS_HAD_RESPONSE_X_FOLLOWING_ANY_TREATMENT_NAME_X(FunctionInput.ONE_TREATMENT_RESPONSE_MANY_SPECIFIC_TREATMENTS),
    HAS_HAD_RADIOLOGICAL_RESPONSE_TO_TREATMENT_WITH_DRUG_X(FunctionInput.ONE_SPECIFIC_DRUG),
    ...
    HAS_HAD_RADIOTHERAPY_TO_BODY_LOCATION_X_FOR_AT_LEAST_Y_LINES(FunctionInput.ONE_STRING_ONE_INTEGER),
    ...
    HAS_HAD_CATEGORY_X_TREATMENT_OF_ONLY_TYPES_Y_FOR_AT_LEAST_Z_MONTHS_AS_MOST_RECENT_LINE(FunctionInput.ONE_TREATMENT_CATEGORY_MANY_TYPES_ONE_INTEGER),
    HAS_HAD_CHEMORADIOTHERAPY_WITH_ANY_DRUG_X_AND_AT_LEAST_Y_CYCLES(FunctionInput.MANY_DRUGS_ONE_INTEGER),
    HAS_HAD_CHEMORADIOTHERAPY_OF_TYPE_X_CHEMOTHERAPY(FunctionInput.ONE_TREATMENT_TYPE),
    HAS_HAD_CHEMORADIOTHERAPY_OF_TYPE_X_CHEMOTHERAPY_AND_AT_LEAST_Y_CYCLES(FunctionInput.ONE_TREATMENT_TYPE_ONE_INTEGER),
    ...
    HAS_PROGRESSIVE_DISEASE_FOLLOWING_DRUG_X_COMBINED_WITH_CATEGORY_Y_TREATMENT_OF_TYPES_Z_FOR_AT_LEAST_A_WEEKS(FunctionInput.ONE_SPECIFIC_DRUG_ONE_TREATMENT_CATEGORY_MANY_TYPES_ONE_INTEGER),
    ...
    HAS_PREVIOUSLY_PARTICIPATED_IN_TRIAL_WITH_ACRONYM_X(FunctionInput.ONE_STRING),
    ...
    IS_PRIMARY_PLATINUM_REFRACTORY_WITHIN_X_MONTHS(FunctionInput.ONE_INTEGER),
    ...
    HAS_MOLECULAR_DRIVER_EVENT_WITH_APPROVED_THERAPY_AVAILABLE(FunctionInput.NONE),
    HAS_MOLECULAR_DRIVER_EVENT_IN_ANY_GENES_X_WITH_APPROVED_THERAPY_AVAILABLE(FunctionInput.MANY_GENES),
    HAS_MOLECULAR_DRIVER_EVENT_IN_NSCLC(FunctionInput.NONE),
    HAS_MOLECULAR_DRIVER_EVENT_IN_NSCLC_IN_ANY_GENES_X(FunctionInput.MANY_GENES),
    HAS_MOLECULAR_DRIVER_EVENT_IN_NSCLC_IN_AT_LEAST_GENES_X(FunctionInput.MANY_GENES),
    HAS_MOLECULAR_DRIVER_EVENT_IN_NSCLC_EXCLUDING_GENES_X(FunctionInput.MANY_GENES),
    HAS_MOLECULAR_DRIVER_EVENT_IN_NSCLC_WITH_AVAILABLE_SOC_ANY_LINE(FunctionInput.NONE),
    HAS_MOLECULAR_DRIVER_EVENT_IN_NSCLC_WITH_AVAILABLE_SOC_ANY_LINE_EXCLUDING_GENES_X(FunctionInput.MANY_GENES),
    HAS_MOLECULAR_DRIVER_EVENT_IN_NSCLC_WITH_AVAILABLE_SOC_FIRST_LINE(FunctionInput.NONE),
    ...
    HAS_DELETION_OF_MTAP(FunctionInput.NONE),
    ...
    ACTIVATING_MUTATION_IN_GENE_X_EXCLUDING_PROTEIN_IMPACTS_Y_AND_TYPE_Z_IN_EXON_A(FunctionInput.ONE_GENE_MANY_PROTEIN_IMPACTS_ONE_VARIANT_TYPE_ONE_INTEGER),
    ...
    HAS_ANY_HLA_TYPE_X(FunctionInput.MANY_HLA_ALLELES),
    ...
    HAS_POSITIVE_PET_SCAN_FOR_TRACER_X(FunctionInput.ONE_STRING),
    ...
    HRD_STATUS_IS_AVAILABLE(FunctionInput.NONE),
    ...
    HAS_SYSTEMIC_IMMUNE_INFLAMMATION_INDEX_OF_AT_MOST_X(FunctionInput.ONE_DOUBLE),
    ...
    HAS_GGT_ULN_OF_AT_MOST_X(FunctionInput.ONE_DOUBLE),
    HAS_GGT_ULN_OF_AT_LEAST_X(FunctionInput.ONE_DOUBLE),
    ...
    HAS_CREATININE_WITHIN_INSTITUTIONAL_NORMAL_LIMITS(FunctionInput.NONE),
    ...
    HAS_CORRECTED_CALCIUM_MG_PER_DL_OF_AT_LEAST_X(FunctionInput.ONE_DOUBLE),
    ...
    HAS_SODIUM_MMOL_PER_L_OF_AT_LEAST_X(FunctionInput.ONE_DOUBLE),
    ...
    HAS_CA19_9_KU_PER_LITER_OF_AT_MOST_X(FunctionInput.ONE_DOUBLE),
    ...
    HAS_TOTAL_PROTEIN_G_PER_L_IN_URINE_OF_AT_LEAST_X(FunctionInput.ONE_DOUBLE),
    HAS_TOTAL_PROTEIN_G_IN_24H_URINE_OF_AT_LEAST_X(FunctionInput.ONE_DOUBLE),
    ...
    HAS_HISTORY_OF_CARDIAC_DISEASE_WITHIN_X_MONTHS(FunctionInput.ONE_INTEGER),
    ...
    HAS_HISTORY_OF_GASTROINTESTINAL_FISTULA(FunctionInput.NONE),
    HAS_HISTORY_OF_IMMUNODEFICIENCY(FunctionInput.NONE),
    ...
    HAS_HISTORY_OF_ARTERIAL_THROMBOEMBOLIC_EVENT_WITHIN_X_MONTHS(FunctionInput.ONE_INTEGER),
    HAS_HISTORY_OF_VENOUS_THROMBOEMBOLIC_EVENT(FunctionInput.NONE),
    HAS_HISTORY_OF_VENOUS_THROMBOEMBOLIC_EVENT_WITHIN_X_MONTHS(FunctionInput.ONE_INTEGER),
    ...
    HAS_CHILD_PUGH_SCORES_X(FunctionInput.MANY_STRINGS),
    ...
    HAS_POTENTIAL_DISRUPTION_OF_LYMPHATIC_DRAINAGE(FunctionInput.NONE),
    ...
    HAS_QTCF_OF_AT_MOST_X_FOR_FEMALE_OR_Y_FOR_MALE(FunctionInput.TWO_DOUBLES),
    ...
    CURRENTLY_GETS_MEDICATION_WITH_CYP_INTERACTION_OF_ANY_TYPE_X(FunctionInput.MANY_DRUG_INTERACTION_TYPES),
    ...
    HAS_RECEIVED_ANY_ANTI_CANCER_THERAPY_EXCL_DRUGS_X_WITHIN_Y_WEEKS(FunctionInput.MANY_DRUGS_ONE_INTEGER),
    ...
    HAD_TOXICITY_X_OF_AT_LEAST_GRADE_Y_DURING_PREVIOUS_TREATMENT(FunctionInput.ONE_STRING_ONE_INTEGER),
