...
enum class EligibilityRule(val input: FunctionInput?) {
    ...
    CURRENTLY_GETS_SYSTEMIC_NAME_X_MEDICATION(FunctionInput.ONE_STRING),
    CURRENTLY_GETS_CATEGORY_X_MEDICATION(FunctionInput.ONE_MEDICATION_CATEGORY),
    CURRENTLY_GETS_SYSTEMIC_CATEGORY_X_MEDICATION(FunctionInput.ONE_MEDICATION_CATEGORY),
    HAS_RECEIVED_CATEGORY_X_MEDICATION_WITHIN_Y_WEEKS(FunctionInput.ONE_MEDICATION_CATEGORY_ONE_INTEGER),
    HAS_RECEIVED_SYSTEMIC_CATEGORY_X_MEDICATION_WITHIN_Y_WEEKS(FunctionInput.ONE_MEDICATION_CATEGORY_ONE_INTEGER),
