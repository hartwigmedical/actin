...
enum class EligibilityRule(val input: FunctionInput?) {
    ...
    CURRENTLY_GETS_PROHIBITED_MEDICATION(null),
    HAS_GLUCOSE_PL_MMOL_PER_L_OF_AT_MOST_X(null),
    CURRENTLY_GETS_IMMUNOSUPPRESSANT_MEDICATION(null),
    CURRENTLY_GETS_GONADORELIN_MEDICATION(null),
    HAS_HISTORY_OF_ANGINA(null),
    HAS_CARDIAC_ARRHYTHMIA(null),
    CURRENTLY_GETS_ANTICOAGULANT_MEDICATION(null),
    WILL_REQUIRE_ANY_ANTICANCER_THERAPY_DURING_TRIAL(null),
    IS_ELIGIBLE_FOR_TREATMENT_WITH_CURATIVE_INTENT(null),
    CURRENTLY_GETS_COUMARIN_DERIVATIVE_MEDICATION(null),
    HAS_STAGE_X(null),
    HAS_ADEQUATE_VEIN_ACCESS_FOR_LEUKAPHERESIS(null),
    HAS_RECEIVED_HERBAL_MEDICATION_OR_DIETARY_SUPPLEMENTS_WITHIN_X_WEEKS(null),
    HAS_KNOWN_HTLV_INFECTION(null),
    HAS_HAD_RECENT_TRAUMA(null),
    IS_FULLY_VACCINATED_AGAINST_COVID_19(null),
    EXPRESSION_OF_GENE_X_BY_IHC_OF_AT_LEAST_Y(null),
    CAN_PROVIDE_ARCHIVAL_OR_FRESH_TISSUE_SAMPLE_FOR_FFPE_ANALYSIS(null),
    MUTATION_IN_GENE_X_OF_TYPE_Y(null),
    MANUFACTURED_T_CELLS_ARE_WITHIN_SHELF_LIFE(null),
    HAS_AT_LEAST_X_LESIONS_WITH_SPECIFIC_CRITERIA(null),
    HAS_D_DIMER_OUTSIDE_REF_UPPER_LIMIT(null),
    IS_ABLE_AND_WILLING_TO_NOT_USE_CONTACT_LENSES(null),
    HAS_RAPIDLY_DETERIORATING_CONDITION(null),
    CURRENTLY_GETS_BONE_RESORPTIVE_MEDICATION(null),
    IS_WILLING_TO_TAKE_PREMEDICATION(null),
    ...
    TML_OF_AT_MOST_X(null),
    IS_TREATED_IN_HOSPITAL_X(null),
    HAS_COLLECTED_TUMOR_BIOPSY_WITHIN_X_MONTHS_BEFORE_IC(null),
    CURRENTLY_GETS_MEDICATION_INHIBITING_OR_INDUCING_DRUG_METABOLIZING_ENZYMES(null),
    MOLECULAR_RESULTS_MUST_BE_AVAILABLE_FOR_GENE_X(null),
    EXPRESSION_OF_GENE_X_BY_IHC(null),
    CAN_PROVIDE_FRESH_TISSUE_SAMPLE_FOR_FFPE_ANALYSIS(null),
    EXPRESSION_OF_GENE_X_BY_IHC_OF_EXACTLY_Y(null),
    HAS_PROSTATE_CANCER_WITH_SMALL_CELL_COMPONENT(null),
    CURRENTLY_GETS_AZOLE_MEDICATION(null),
    HAS_HISTORY_OF_BRAIN_DISEASE(null),
    HAS_HAD_ANY_CANCER_TREATMENT_IGNORING_CATEGORIES_WITH_NAME_X(null),
    HAS_POST_OPERATIVE_BASELINE_CONTRAST_ENHANCED_MRI_SCAN(null),
    HAS_BREAST_CANCER_HORMONE_POSITIVE_AND_HER2_NEGATIVE(null)
}
