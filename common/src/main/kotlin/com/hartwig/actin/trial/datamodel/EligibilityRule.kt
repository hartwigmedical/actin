...
enum class EligibilityRule(val input: FunctionInput?) {
    ...
    HAS_STAGE_X(FunctionInput.ONE_TUMOR_STAGE),
    ...
    HAS_HAD_SYSTEMIC_THERAPY_WITHIN_X_MONTHS(FunctionInput.ONE_INTEGER),
    HAS_HAD_SYSTEMIC_THERAPY_WITH_ANY_INTENT_X_WITHIN_Y_MONTHS(FunctionInput.MANY_INTENTS_ONE_INTEGER),
    ...
    HAS_MOLECULAR_EVENT_WITH_TARGETED_THERAPY_AVAILABLE_IN_NSCLC(FunctionInput.NONE),
    HAS_MOLECULAR_EVENT_WITH_TARGETED_THERAPY_AVAILABLE_IN_NSCLC_EXCLUDING_GENE_X(FunctionInput.ONE_GENE),
    ...
    CURRENTLY_GETS_CATEGORY_X_MEDICATION(FunctionInput.ONE_STRING),
    HAS_RECEIVED_CATEGORY_X_MEDICATION_WITHIN_Y_WEEKS(FunctionInput.ONE_STRING_ONE_INTEGER),
    ...
    CURRENTLY_GETS_MEDICATION_INHIBITING_CYP_X(FunctionInput.ONE_STRING),
    CURRENTLY_GETS_MEDICATION_INDUCING_CYP_X(FunctionInput.ONE_STRING),
    HAS_RECEIVED_MEDICATION_INDUCING_CYP_X_WITHIN_Y_WEEKS(FunctionInput.ONE_STRING_ONE_INTEGER),
    CURRENTLY_GETS_MEDICATION_INHIBITING_OR_INDUCING_ANY_CYP(FunctionInput.NONE),
    CURRENTLY_GETS_MEDICATION_INHIBITING_OR_INDUCING_CYP_X(FunctionInput.ONE_STRING),
    CURRENTLY_GETS_MEDICATION_SUBSTRATE_OF_CYP_X(FunctionInput.ONE_STRING),
    ...
    HAS_RECEIVED_CATEGORIES_X_CANCER_THERAPY_WITHIN_Y_WEEKS(FunctionInput.MANY_STRINGS_ONE_INTEGER),
    HAS_RECEIVED_CATEGORIES_X_CANCER_THERAPY_WITHIN_Y_WEEKS_Z_HALF_LIVES(FunctionInput.MANY_STRINGS_TWO_INTEGERS),
    ...
    HAS_RECEIVED_ANY_ANTI_CANCER_THERAPY_EXCL_CATEGORIES_X_WITHIN_Y_WEEKS(FunctionInput.MANY_STRINGS_ONE_INTEGER),
    HAS_RECEIVED_ANY_ANTI_CANCER_THERAPY_WITHIN_X_WEEKS_Y_HALF_LIVES(FunctionInput.TWO_INTEGERS),
    HAS_RECEIVED_ANY_ANTI_CANCER_THERAPY_EXCL_CATEGORIES_X_WITHIN_Y_WEEKS_Z_HALF_LIVES(FunctionInput.MANY_STRINGS_TWO_INTEGERS),
