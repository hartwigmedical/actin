...
enum class EligibilityRule(val input: FunctionInput?) {
    ...
    HAS_PREVIOUSLY_PARTICIPATED_IN_CURRENT_TRIAL(FunctionInput.NONE),
    ...
    HRD_SIGNATURE_WITHOUT_MUTATION_OR_WITH_VUS_MUTATION_IN_BRCA(FunctionInput.NONE),
    ...
    IS_PARTICIPATING_IN_ANOTHER_TRIAL(FunctionInput.NONE),
    HAS_LVEF_OF_AT_LEAST_X_IF_KNOWN(FunctionInput.NONE),
    ACTIVATING_MUTATION_IN_GENE_X(FunctionInput.NONE),
    CURRENTLY_GETS_PROHIBITED_MEDICATION(FunctionInput.NONE),
    HAS_GLUCOSE_PL_MMOL_PER_L_OF_AT_MOST_X(FunctionInput.NONE),
    CURRENTLY_GETS_IMMUNOSUPPRESSANT_MEDICATION(FunctionInput.NONE),
    CURRENTLY_GETS_GONADORELIN_MEDICATION(FunctionInput.NONE),
    HAS_HISTORY_OF_ANGINA(FunctionInput.NONE),
    HAS_CARDIAC_ARRHYTHMIA(FunctionInput.NONE),
    CURRENTLY_GETS_ANTICOAGULANT_MEDICATION(FunctionInput.NONE),
    WILL_REQUIRE_ANY_ANTICANCER_THERAPY_DURING_TRIAL(FunctionInput.NONE),
    IS_ELIGIBLE_FOR_TREATMENT_WITH_CURATIVE_INTENT(FunctionInput.NONE),
    CURRENTLY_GETS_COUMARIN_DERIVATIVE_MEDICATION(FunctionInput.NONE),
    HAS_STAGE_X(FunctionInput.NONE),
    HAS_ADEQUATE_VEIN_ACCESS_FOR_LEUKAPHERESIS(FunctionInput.NONE),
    HAS_RECEIVED_HERBAL_MEDICATION_OR_DIETARY_SUPPLEMENTS_WITHIN_X_WEEKS(FunctionInput.NONE),
    HAS_KNOWN_HTLV_INFECTION(FunctionInput.NONE),
    HAS_HAD_RECENT_TRAUMA(FunctionInput.NONE),
    IS_FULLY_VACCINATED_AGAINST_COVID_19(FunctionInput.NONE),
    EXPRESSION_OF_GENE_X_BY_IHC_OF_AT_LEAST_Y(FunctionInput.NONE),
    CAN_PROVIDE_ARCHIVAL_OR_FRESH_TISSUE_SAMPLE_FOR_FFPE_ANALYSIS(FunctionInput.NONE),
    MUTATION_IN_GENE_X_OF_TYPE_Y(FunctionInput.NONE),
    MANUFACTURED_T_CELLS_ARE_WITHIN_SHELF_LIFE(FunctionInput.NONE),
    HAS_AT_LEAST_X_LESIONS_WITH_SPECIFIC_CRITERIA(FunctionInput.NONE),
    HAS_D_DIMER_OUTSIDE_REF_UPPER_LIMIT(FunctionInput.NONE),
    IS_ABLE_AND_WILLING_TO_NOT_USE_CONTACT_LENSES(FunctionInput.NONE),
    HAS_RAPIDLY_DETERIORATING_CONDITION(FunctionInput.NONE),
    CURRENTLY_GETS_BONE_RESORPTIVE_MEDICATION(FunctionInput.NONE),
    IS_WILLING_TO_TAKE_PREMEDICATION(FunctionInput.NONE),
    HAS_SPINAL_CORD_COMPRESSION(FunctionInput.NONE),
    HAS_BLADDER_OUTFLOW_OBSTRUCTION(FunctionInput.NONE),
    HAS_URINARY_INCONTINENCE(FunctionInput.NONE),
    HAS_UNCONTROLLED_TUMOR_RELATED_PAIN(FunctionInput.NONE),
    MEETS_COVID_19_VACCINATION_REQUIREMENTS(FunctionInput.NONE),
    TML_OF_AT_MOST_X(FunctionInput.NONE),
    IS_TREATED_IN_HOSPITAL_X(FunctionInput.NONE),
    HAS_COLLECTED_TUMOR_BIOPSY_WITHIN_X_MONTHS_BEFORE_IC(FunctionInput.NONE),
    CURRENTLY_GETS_MEDICATION_INHIBITING_OR_INDUCING_DRUG_METABOLIZING_ENZYMES(FunctionInput.NONE),
    MOLECULAR_RESULTS_MUST_BE_AVAILABLE_FOR_GENE_X(FunctionInput.NONE),
    EXPRESSION_OF_GENE_X_BY_IHC(FunctionInput.NONE),
    CAN_PROVIDE_FRESH_TISSUE_SAMPLE_FOR_FFPE_ANALYSIS(FunctionInput.NONE),
    EXPRESSION_OF_GENE_X_BY_IHC_OF_EXACTLY_Y(FunctionInput.NONE),
    HAS_PROSTATE_CANCER_WITH_SMALL_CELL_COMPONENT(FunctionInput.NONE),
    CURRENTLY_GETS_AZOLE_MEDICATION(FunctionInput.NONE),
    HAS_HISTORY_OF_BRAIN_DISEASE(FunctionInput.NONE),
    HAS_HAD_ANY_CANCER_TREATMENT_IGNORING_CATEGORIES_WITH_NAME_X(FunctionInput.NONE),
    HAS_POST_OPERATIVE_BASELINE_CONTRAST_ENHANCED_MRI_SCAN(FunctionInput.NONE),
    HAS_BREAST_CANCER_HORMONE_POSITIVE_AND_HER2_NEGATIVE(FunctionInput.NONE),
    MOLECULAR_RESULTS_MUST_BE_AVAILABLE_BUT_NOT_INDETERMINATE_FOR_PROMOTER_OF_GENE_X(FunctionInput.NONE),
    MOLECULAR_RESULTS_MUST_BE_AVAILABLE_FOR_PROMOTER_OF_GENE_X(FunctionInput.NONE),
    HAS_RECEIVED_HER2_TARGETING_ADC(FunctionInput.NONE),
    POSITIVE_FOR_CD8_T_CELLS_BY_IHC(FunctionInput.NONE)
}
