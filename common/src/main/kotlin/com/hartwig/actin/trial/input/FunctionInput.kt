...
object FunctionInput {
    ...
    val ONE_SPECIFIC_TREATMENT_ONE_INTENT = listOf(Parameter.Type.TREATMENT, Parameter.Type.INTENT)
    ...
    val ONE_SPECIFIC_DRUG_ONE_TREATMENT_CATEGORY_MANY_TYPES_ONE_INTEGER =
        listOf(Parameter.Type.DRUG, Parameter.Type.TREATMENT_CATEGORY, Parameter.Type.MANY_TREATMENT_TYPES, Parameter.Type.INTEGER)
