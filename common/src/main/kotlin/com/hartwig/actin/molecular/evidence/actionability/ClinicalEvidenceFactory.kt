...
class ClinicalEvidenceFactory(
    ...
    fun create(actionabilityMatch: ActionabilityMatch): ClinicalEvidence {
        return ClinicalEvidence(
            treatmentEvidence = convertToTreatmentEvidences(actionabilityMatch.evidenceMatches, false) + convertToTreatmentEvidences(actionabilityMatch.indirectEvidenceMatches, true),
