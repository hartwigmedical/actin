...
data class GenericSmallVariant(
    val gene: String,
    val hgvsCodingImpact: String
) : PanelEvent {
    companion object {
        fun parseVariant(priorMolecularTest: PriorMolecularTest): GenericSmallVariant {
            return if (priorMolecularTest.item != null && priorMolecularTest.measure != null) {
                GenericSmallVariant(gene = priorMolecularTest.item, hgvsCodingImpact = priorMolecularTest.measure)
            } else {
