...
object CancerAssociatedVariantFunctions {

    private val SERVE_CANCER_ASSOCIATED_VARIANT_PROTEIN_EFFECTS = setOf(
    ...
    fun isCancerAssociatedVariant(geneAlteration: GeneAlteration?): Boolean {
        return if ((geneAlteration is KnownHotspot && geneAlteration.sources().contains(PRIMARY_KNOWN_EVENT_SOURCE)) ||
            ...
            geneAlteration.proteinEffect() in SERVE_CANCER_ASSOCIATED_VARIANT_PROTEIN_EFFECTS
