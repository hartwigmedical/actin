...
class EvidenceDatabase(
    ...
    private val clinicalEvidenceMatcherFactory: ClinicalEvidenceMatcherFactory
//    private val clinicalEvidenceMatcher: ClinicalEvidenceMatcher
) {

    fun clinicalEvidenceMatcher(molecularTest: MolecularTest): ClinicalEvidenceMatcher {
        return clinicalEvidenceMatcherFactory.create(molecularTest)
    }
