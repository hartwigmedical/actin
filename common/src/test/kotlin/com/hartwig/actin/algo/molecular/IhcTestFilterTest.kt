...
class IhcTestFilterTest {
    ...
    fun `Should filter prior molecular tests for PDL1`() {
        val test1 = ihcTest(test = "Archer", item = "PD-L1")
        val test2 = ihcTest(test = "IHC", item = "PD-L1")
        val test3 = ihcTest(test = "IHC", item = "BRAF")
    ...
    fun `Should filter prior molecular tests for PDL1 with specific measure`() {
        val test1 = ihcTest(test = "Archer", item = "PD-L1")
        val test2 = ihcTest(test = "IHC", item = "PD-L1", measure = "CPS")
        val test3 = ihcTest(test = "IHC", item = "PD-L1", measure = "wrong")
        val test4 = ihcTest(test = "IHC", item = "BRAF")
    ...
    fun `Should assume that measurement is TPS if cancer is (subtype of) lung cancer and measurement is not specified`() {
        val test1 = ihcTest(test = "Archer", item = "PD-L1", measure = null)
        val test2 = ihcTest(test = "IHC", item = "PD-L1", measure = null)
    ...
    fun `Should filter prior molecular tests on IHC for specific protein`() {
        val test1 = ihcTest(test = "Archer", item = "protein 1")
        val test2 = ihcTest(test = "IHC", item = "protein 1")
        val test3 = ihcTest(test = "IHC", item = "protein 2")
    ...
    fun `Should filter most recent and tests without dates for each protein`() {
        val test1 = ihcTest(test = "IHC", item = "protein 1", measureDate = null)
        val test2 = test1.copy(measureDate = LocalDate.of(2025, 2, 11))
        val test3 = test1.copy(measureDate = LocalDate.of(2024, 2, 11))
        val test4 = ihcTest(test = "IHC", item = "protein 2", measureDate = LocalDate.of(2023, 2, 11))
    ...
    fun `Should return all tests of most recent date except if tests are completely identical`() {
        val test1 = ihcTest(test = "IHC", item = "protein 1", measureDate = LocalDate.of(2024, 2, 2))
    ...
    private fun ihcTest(test: String = "", item: String = "", measure: String? = null, measureDate: LocalDate? = null): IHCTest {
        return IHCTest(test = test, item = item, measure = measure, measureDate = measureDate)
    }
}