...
class TreatmentMatchJsonTest {
    ...
    fun `Should sort messages prior to serialization`() {
        ...
        val expectedJson = ("{\"patientId\":\"ACTN01029999\",\"sampleId\":\"ACTN01029999T\",\"trialSource\":\"EMC\","
                ...
                + "\"failGeneralMessages\":[]}],\"annotations\":[{\"acronym\":\"Study of Pembrolizumab\",\"phase\":\"Phase III\","
                ...
                + "\"resistanceEvidence\":[{\"event\":\"BRAF amp\",\"isTested\":null,\"isFound\":null,\"resistanceLevel\":\"A\",\"evidenceUrls\":[\"website\"],\"subTreatmentName\":\"Pembrolizumab\"}]}],"
                + "\"personalizedDataAnalysis\":null}")
