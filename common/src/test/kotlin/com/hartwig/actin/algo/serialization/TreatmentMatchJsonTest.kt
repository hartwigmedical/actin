...
class TreatmentMatchJsonTest {
    ...
    fun `Should sort messages prior to serialization`() {
        ...
        //@formatter:off
        val expectedJson = ("{\"patientId\":\"ACTN01029999\","
                ...
                + "\"trialMatches\":["
                    ...
                    + ",\"locations\":[\"Antoni van Leeuwenhoek\"]},"
                ...
                + "\"annotations\":["
                    ...
                    + "\"treatments\":["
                        + "{\"name\":\"PEMBROLIZUMAB\",\"drugs\":["
                            + "{\"name\":\"PEMBROLIZUMAB\",\"drugTypes\":[\"TOPO1_INHIBITOR\"],"
                            + "\"category\":\"CHEMOTHERAPY\",\"displayOverride\":null}],"
                        + "\"synonyms\":[],\"displayOverride\":null,\"isSystemic\":true,"
                        + "\"maxCycles\":null,\"treatmentClass\":\"DRUG_TREATMENT\"}],"
                    ...
                    + "\"trialReferences\":["
                        + "{\"patientPopulations\":["
                            ...
                            + "\"medianFollowUpForSurvival\":\"30\",\"medianFollowUpPFS\":\"30\",\"analysisGroups\":["
                                + "{\"id\":1,\"name\":\"Analysis group\",\"nPatients\":200,\"endPoints\":["
                                + "{\"id\":2,\"name\":\"Median Progression-Free Survival\",\"value\":6.8,\"unitOfMeasure\":\"MONTHS\","
                                + "\"confidenceInterval\":null,\"type\":\"PRIMARY\",\"derivedMetrics\":["
