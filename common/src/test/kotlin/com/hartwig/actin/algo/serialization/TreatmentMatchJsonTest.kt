...
class TreatmentMatchJsonTest {
    ...
    fun `Should sort messages prior to serialization`() {
        ...
        val expectedJson = ("{\"patientId\":\"ACTN01029999\",\"sampleId\":\"ACTN01029999T\",\"trialSource\":\"EMC\","
                ...
                + "\"failSpecificMessages\":[],\"failGeneralMessages\":[],\"missingGenesForSufficientEvaluation\":[]}]],\"cohorts\":[]}],"
                ...
                + "\"failGeneralMessages\":[],\"missingGenesForSufficientEvaluation\":[]}],\"annotations\":[{\"acronym\":\"Study of Pembrolizumab\",\"phase\":\"Phase III\","
