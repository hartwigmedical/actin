...
// TODO are there equiavlent tests in the ClinicalEvidenceMatcher layer?
//  if not, should migrate these tests to that layer
...
//            isReportable = true
//        )
//        val matchCriteria = MatchingCriteriaFunctions.createVariantCriteria(variant)
//        assertThat(database.geneAlterationForVariant(matchCriteria)).isNotNull()
