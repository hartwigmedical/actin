...
class LabValueDescendingDateComparatorTest {
    ...
    fun `Should sort lab values`() {
        ...
        val value1 = minimal.copy(date = LocalDate.of(2018, 1, 1), code = "Y", value = 0.0)
        val value2 = minimal.copy(date = LocalDate.of(2019, 1, 1), code = "X", value = 0.0)
        val value3 = minimal.copy(date = LocalDate.of(2018, 1, 1), code = "X", value = 1.0)
        val value4 = minimal.copy(date = LocalDate.of(2018, 1, 1), code = "X", value = 2.0)
