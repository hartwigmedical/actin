...
class CurrentlyGetsCypXInhibitingOrInducingMedicationTest {
    ...
    private val alwaysActiveFunction =
        CurrentlyGetsCypXInhibitingOrInducingMedication(MedicationTestFactory.alwaysActive(), TARGET_CYP, labels)
    private val alwaysPlannedFunction =
        CurrentlyGetsCypXInhibitingOrInducingMedication(MedicationTestFactory.alwaysPlanned(), TARGET_CYP, labels)
