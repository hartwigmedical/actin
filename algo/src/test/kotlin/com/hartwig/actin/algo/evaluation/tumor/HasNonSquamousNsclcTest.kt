...
class HasNonSquamousNsclcTest {
    ...
    fun `Should return warn when known non-squamous NSCLC type but possible SCC transition`() {
        ...
        assertThat(evaluation.warnMessagesStrings()).containsExactly("Has non-squamous NSCLC but also possibly positive SCC transition results")
    }
    ...
    fun `Should return warn when known non-squamous NSCLC type but certain SCC transition`() {
        ...
        assertEvaluation(EvaluationResult.WARN, evaluation)
        assertThat(evaluation.warnMessagesStrings()).containsExactly("Has non-squamous NSCLC but also has positive SCC transition results")
    }
