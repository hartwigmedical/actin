...
class IsPlatinumResistantTest {
    ...
    private val function = IsPlatinumResistant(referenceDate, labels)
    ...
    @Test
    fun `Should pass if treatment history contains platinum with progression as last treatment and within 6 months`() {
        val history = listOf(
            TreatmentTestFactory.treatmentHistoryEntry(
                treatments = setOf(platinum),
                bestResponse = TreatmentResponse.PROGRESSIVE_DISEASE,
    ...
    @Test
    fun `Should pass if treatment history contains platinum with progression and next treatment starts within 6 months`() {
        val history = listOf(
            TreatmentTestFactory.treatmentHistoryEntry(
                treatments = setOf(platinum),
                bestResponse = TreatmentResponse.PROGRESSIVE_DISEASE,
