...
public class HasLimitedDerivedCreatinineClearanceTest {

    @Test
    public void canEvaluateMDRD() {
        HasLimitedDerivedCreatinineClearance function =
                new HasLimitedDerivedCreatinineClearance(2021, CreatinineClearanceMethod.EGFR_MDRD, 100D);
    ...
    public void canEvaluateCKDEPI() {
        HasLimitedDerivedCreatinineClearance function =
                new HasLimitedDerivedCreatinineClearance(2021, CreatinineClearanceMethod.EGFR_CKD_EPI, 100D);
    ...
    public void canEvaluateCockcroftGaultWithWeight() {
        HasLimitedDerivedCreatinineClearance function =
                new HasLimitedDerivedCreatinineClearance(2021, CreatinineClearanceMethod.COCKCROFT_GAULT, 100D);
    ...
    public void canEvaluateCockcroftGaultNoWeight() {
        HasLimitedDerivedCreatinineClearance function =
                new HasLimitedDerivedCreatinineClearance(2021, CreatinineClearanceMethod.COCKCROFT_GAULT, 80);
