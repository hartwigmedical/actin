...
class CurrentlyGetsCypXInducingMedicationTest {
    ...
    private val alwaysActiveFunction = CurrentlyGetsCypXInducingMedication(MedicationTestFactory.alwaysActive(), TARGET_CYP, labels)
    private val alwaysPlannedFunction = CurrentlyGetsCypXInducingMedication(MedicationTestFactory.alwaysPlanned(), TARGET_CYP, labels)
