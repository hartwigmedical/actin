...
class HasHadPDFollowingTreatmentWithCategoryOfTypesAndCyclesOrWeeksTest {
    ...
    fun shouldReturnUndeterminedForRightCategoryAndMissingTypeWithPD() {
        val treatmentHistoryEntry =
            treatmentHistoryEntry(setOf(drugTherapy("test", MATCHING_CATEGORY)), stopReason = StopReason.PROGRESSIVE_DISEASE)
    ...
    companion object {
        ...
        private val MATCHING_TREATMENT_SET = setOf(drugTherapy("test", MATCHING_CATEGORY, MATCHING_TYPE_SET))
