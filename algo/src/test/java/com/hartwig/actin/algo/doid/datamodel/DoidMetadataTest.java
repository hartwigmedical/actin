...
public class DoidMetadataTest {
    ...
    public void canResolveSnomedConceptID() {
        ...
        DoidMetadata differentID = ImmutableDoidMetadata.builder().addXrefs(ImmutableDoidXref.builder().val("HMF:1").build()).build();

        assertNull(differentID.snomedConceptId());

        DoidMetadata wrongSnomedFormat =
                ImmutableDoidMetadata.builder().addXrefs(ImmutableDoidXref.builder().val("SNOMED found!").build()).build();
