...
public class AndTest {
    ...
    public void canCombineEvaluations() {
        ...
        assertEquals(EvaluationResult.NOT_EVALUATED, combinedWithPass(TestEvaluationFunctionFactory.notEvaluated()));
        ...
        assertEquals(EvaluationResult.NOT_EVALUATED, combinedWithPassButWarn(TestEvaluationFunctionFactory.notEvaluated()));
        ...
        assertEquals(EvaluationResult.NOT_EVALUATED, combinedWithNotEvaluated(TestEvaluationFunctionFactory.pass()));
        assertEquals(EvaluationResult.NOT_EVALUATED, combinedWithNotEvaluated(TestEvaluationFunctionFactory.passButWarn()));
