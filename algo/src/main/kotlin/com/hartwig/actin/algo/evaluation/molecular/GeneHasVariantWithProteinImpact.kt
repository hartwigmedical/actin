                ...
                for (allowedProteinImpact in allowedProteinImpacts) {
                    if (canonicalProteinImpact == allowedProteinImpact) {
                        ...
                        if (variant.isReportable) {
                            if (variant.nullSafeExtendedVariant().clonalLikelihood < CLONAL_CUTOFF) {
                    ...
                    if (variant.isReportable) {
                        for (otherProteinImpact in toProteinImpacts(variant.nullSafeExtendedVariant().otherImpacts)) {
