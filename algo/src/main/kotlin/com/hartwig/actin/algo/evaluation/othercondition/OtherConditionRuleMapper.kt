...
class OtherConditionRuleMapper(resources: RuleMappingResources) : RuleMapper(resources) {
    ...
    override fun createMappings(): Map<EligibilityRule, FunctionCreator> {
        return mapOf(
            ...
            EligibilityRule.HAS_HISTORY_OF_AUTOIMMUNE_DISEASE to hasPriorConditionWithIcdCodesFromListCreator(IcdConstants.AUTOIMMUNE_DISEASE_LIST, "autoimmune disease"),
            EligibilityRule.HAS_HISTORY_OF_CARDIAC_DISEASE to hasHistoryOfCardiacDiseaseCreator(),
            EligibilityRule.HAS_HISTORY_OF_CARDIOVASCULAR_DISEASE to hasPriorConditionWithIcdCodeCreator(IcdConstants.CIRCULATORY_SYSTEM_DISEASE_CHAPTER),
            ...
            EligibilityRule.HAS_HISTORY_OF_CENTRAL_NERVOUS_SYSTEM_DISEASE to hasPriorConditionWithIcdCodeCreator(IcdConstants.NERVOUS_SYSTEM_DISEASE_CHAPTER),
            EligibilityRule.HAS_HISTORY_OF_EYE_DISEASE to hasHistoryOfEyeDiseaseCreator(),
            EligibilityRule.HAS_HISTORY_OF_GASTROINTESTINAL_DISEASE to hasPriorConditionWithIcdCodeCreator(IcdConstants.DIGESTIVE_SYSTEM_DISEASE_CHAPTER),
            EligibilityRule.HAS_HISTORY_OF_IMMUNE_SYSTEM_DISEASE to hasPriorConditionWithIcdCodeCreator(IcdConstants.IMMUNE_SYSTEM_DISEASE_CHAPTER),
            EligibilityRule.HAS_HISTORY_OF_INTERSTITIAL_LUNG_DISEASE to hasPriorConditionWithIcdCodeCreator(IcdConstants.LUNG_INTERSTITIAL_DISEASES_BLOCK),
            EligibilityRule.HAS_HISTORY_OF_LIVER_DISEASE to hasPriorConditionWithIcdCodeCreator(IcdConstants.LIVER_DISEASE_BLOCK),
            EligibilityRule.HAS_HISTORY_OF_LUNG_DISEASE to hasPriorConditionWithIcdCodesFromListCreator(IcdConstants.RESPIRATORY_COMPROMISE_LIST, "lung disease"),
            ...
            EligibilityRule.HAS_HISTORY_OF_MYOCARDIAL_INFARCT to hasPriorConditionWithIcdCodeCreator(IcdConstants.ACUTE_MYOCARDIAL_INFARCT_CODE),
            ...
            EligibilityRule.HAS_HISTORY_OF_PNEUMONITIS to hasPriorConditionWithIcdCodeCreator(IcdConstants.PNEUMONITIS_BLOCK),
            ...
            EligibilityRule.HAS_HISTORY_OF_VASCULAR_DISEASE to hasPriorConditionWithIcdCodesFromListCreator(listOf(IcdConstants.ARTERY_DISEASE_BLOCK, IcdConstants.VEIN_DISEASE_BLOCK), "vascular disease"),
            ...
            EligibilityRule.HAS_GILBERT_DISEASE to hasPriorConditionWithIcdCodeCreator(IcdConstants.GILBERT_SYNDROME_CODE),
            EligibilityRule.HAS_HYPERTENSION to hasPriorConditionWithIcdCodeCreator(IcdConstants.HYPERTENSIVE_DISEASES_BLOCK),
            EligibilityRule.HAS_HYPOTENSION to hasPriorConditionWithNameCreator(HYPOTENSION_NAME),
            EligibilityRule.HAS_DIABETES to hasPriorConditionWithIcdCodeCreator(IcdConstants.DIABETES_MELLITUS_BLOCK),
    ...
    private fun hasPriorConditionWithIcdCodeCreator(targetIcdCode: String): FunctionCreator {
