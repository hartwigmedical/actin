...
class MolecularRuleMapper(resources: RuleMappingResources) : RuleMapper(resources) {
    ...
    override fun createMappings(): Map<EligibilityRule, FunctionCreator> {
        return mapOf(
            ...
            EligibilityRule.INACTIVATION_OF_GENE_X to geneIsInactivatedOrDeletedCreator(onlyDeletions = false),
            EligibilityRule.DELETION_OF_GENE_X to geneIsInactivatedOrDeletedCreator(onlyDeletions = true),
    ...
    private fun geneIsInactivatedOrDeletedCreator(onlyDeletions: Boolean): FunctionCreator {
        return { function: EligibilityFunction ->
            GeneIsInactivated(
