...
class MolecularRuleMapper(resources: RuleMappingResources) : RuleMapper(resources) {
    override fun createMappings(): Map<EligibilityRule, FunctionCreator> {
        return mapOf(
            ...
            EligibilityRule.HPV_STATUS_MUST_BE_AVAILABLE to hasAvailableHPVStatusCreator(),
    ...
    private fun hasAvailableHPVStatusCreator(): FunctionCreator {
        return FunctionCreator { HasAvailableHPVStatus() }
    }
