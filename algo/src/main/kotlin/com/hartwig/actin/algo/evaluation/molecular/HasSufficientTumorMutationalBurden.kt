    ...
    override fun evaluate(test: MolecularTest): Evaluation {
        ...
        if (tumorMutationalBurden >= minTumorMutationalBurden) {
            return EvaluationFactory.pass(
                ...
                inclusionEvents = setOf(MolecularEvent(MolecularCharacteristicEvents.HIGH_TUMOR_MUTATIONAL_BURDEN))
            )
        }
        ...
        return if (tumorMutationalBurdenIsAlmostAllowed && test.hasSufficientQualityButLowPurity()) {
            EvaluationFactory.warn(
                ...
                inclusionEvents = setOf(MolecularEvent(MolecularCharacteristicEvents.ALMOST_SUFFICIENT_TUMOR_MUTATIONAL_BURDEN))
            )
