...
class HasHadFirstLineTreatmentCategoryOfTypes(private val labels: EvaluationLabels.Treatment) : EvaluationFunction {

    override fun evaluate(record: PatientRecord): Evaluation {
        return EvaluationFactory.undetermined(labels.hasHadFirstLineTreatmentCategoryOfTypesUndetermined())
    }
}