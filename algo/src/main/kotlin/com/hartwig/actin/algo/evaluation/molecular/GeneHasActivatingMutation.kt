...
class GeneHasActivatingMutation internal constructor(private val gene: String) : EvaluationFunction {
    ...
    private fun evaluatePotentialWarns(
        ...
        nonHighDriverVariants: Set<String>, otherMissenseOrHotspotVariants: Set<String>
    ): Evaluation? {
        ...
        if (activatingSubclonalVariants.isNotEmpty()) {
            ...
            warnSpecificMessages.add(
                "Gene " + gene + " potentially activating mutation(s) " + Format.concat(activatingSubclonalVariants) + " have subclonal likelihood of > " + Format.percentage(
                    1 - CLONAL_CUTOFF
                )
            )
            warnGeneralMessages.add(
