    ...
    override fun evaluate(record: PatientRecord): Evaluation {
        ...
        return when {
            ...
            treatmentSummary.hasPossibleTrialMatch() -> EvaluationFactory.undetermined(
                "Patient may have received ${category.display()} in a trial, ignoring ${concat(ignoreTypes)}",
                "Undetermined if received ${category.display()}, ignoring ${concat(ignoreTypes)}"
            )
