...
public final class VitalFunctionRuleMapping {
    ...
    public static Map<EligibilityRule, FunctionCreator> create() {
        ...
        map.put(EligibilityRule.HAS_PULSE_OXYMETRY_OF_AT_LEAST_X, function -> record -> EvaluationResult.NOT_IMPLEMENTED);
        map.put(EligibilityRule.HAS_BODY_WEIGHT_OF_AT_LEAST_X, function -> record -> EvaluationResult.NOT_IMPLEMENTED);
