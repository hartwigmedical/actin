...
public final class LaboratoryRuleMapping {
    ...
    public static Map<EligibilityRule, FunctionCreator> create() {
        ...
        map.put(EligibilityRule.HAS_GLUCOSE_PL_MMOL_PER_L_OF_AT_MOST_X, function -> record -> Evaluation.NOT_IMPLEMENTED);
        map.put(EligibilityRule.HAS_SERUM_TESTOSTERONE_NG_PER_DL_OF_AT_MOST_X, function -> record -> Evaluation.NOT_IMPLEMENTED);
        map.put(EligibilityRule.HAS_CREATININE_MG_PER_DL_OF_AT_MOST_X, function -> record -> Evaluation.NOT_IMPLEMENTED);
        ...
        map.put(EligibilityRule.HAS_PTT_ULN_OF_AT_MOST_X, function -> record -> Evaluation.NOT_IMPLEMENTED);
        ...
        map.put(EligibilityRule.HAS_AFP_ULN_OF_AT_LEAST_X, function -> record -> Evaluation.NOT_IMPLEMENTED);
        map.put(EligibilityRule.HAS_CA125_ULN_OF_AT_LEAST_X, function -> record -> Evaluation.NOT_IMPLEMENTED);
        map.put(EligibilityRule.HAS_HCG_ULN_OF_AT_LEAST_X, function -> record -> Evaluation.NOT_IMPLEMENTED);
        ...
        map.put(EligibilityRule.HAS_TOTAL_PROTEIN_IN_24H_URINE_OF_AT_LEAST_X, function -> record -> Evaluation.NOT_IMPLEMENTED);
