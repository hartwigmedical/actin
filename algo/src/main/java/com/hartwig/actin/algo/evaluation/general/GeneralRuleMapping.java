...
public final class GeneralRuleMapping {
    ...
    public static Map<EligibilityRule, FunctionCreator> create() {
        ...
        map.put(EligibilityRule.IS_MALE, function -> record -> Evaluation.NOT_IMPLEMENTED);
        ...
        map.put(EligibilityRule.HAS_PARTICIPATED_IN_CURRENT_TRIAL, function -> record -> Evaluation.NOT_IMPLEMENTED);
