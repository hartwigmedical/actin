...
public final class GeneralRuleMapping {
    ...
    public static Map<EligibilityRule, FunctionCreator> create() {
        ...
        map.put(EligibilityRule.IS_MALE, function -> record -> EvaluationResult.NOT_IMPLEMENTED);
        ...
        map.put(EligibilityRule.HAS_PARTICIPATED_IN_CURRENT_TRIAL, function -> record -> EvaluationResult.NOT_IMPLEMENTED);
        ...
        map.put(EligibilityRule.PATIENT_WILL_BE_PARTICIPATING_IN_COUNTRY_X, function -> record -> EvaluationResult.NOT_IMPLEMENTED);
