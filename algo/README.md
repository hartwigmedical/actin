...
| HAS_CANCER_OF_UNKNOWN_PRIMARY_AND_TYPE_X                       | ALL configured DOIDs equal or child of DOID of tumor type X specified, and none of configured DOIDs should be equal or child of DOID 0050686. Resolve to `UNDETERMINED` in case ALL configured DOIDs exactly equal to DOID 162 and tumor sublocation is not "CUP"                                                                                                                                           | X can be one of: Carcinoma (DOID 305), Adenocarcinoma (DOID: 299), Squamous cell carcinoma (DOID: 1749), Melanoma (DOID: 1909)                                                                                                                                                                                                                               |
